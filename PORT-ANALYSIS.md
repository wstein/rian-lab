...
- modules: 45 · type slots: 3047 · auto-filled: 711 (23%) · holes: 2336
...
```rian
  ...
  # CLI.each/2
  pub def each(files Unk0055, fun Fn(Unk0057, Unk0056)) Unk0058 := …
  ...
  pub def lin_check(env Map(Unk0070, Unk0071), ast Unk0069) Tuple(Unk0073, Vec(Unk0072)) := …

  # Capability.lin_check_block/3
  pub def lin_check_block(env Map(Unk0075, Unk0074), bindings Vec(Unk0076), final Unk0069) Tuple(Unk0073, Vec(Unk0072)) := …
  ...
  pub def verdict(env Map(Unk0070, Unk0071), uses Unk0068) Tuple(Unk0073, Vec(Unk0072)) := …
  ...
  # Check.all_types/1
  pub def all_types(prog Map(Unk0085, Vec(Map(Unk0010, Vec(Unk0009))))) Vec(Type) := …
  ...
  pub def check_program(p0 Map(Unk0022, Vec(Map(Unk0010, Vec(Unk0009))))) Unk0111 := …
  ...
  # Check.const_int/1
  pub def const_int(p0 Option(Unk0017)) Tuple(Unk0117, Unk0116) := …

  # Check.ctor_type/2
  pub def ctor_type(ic Map(Unk0081, Map(Vec(Unk0079), Vec(Unk0079))), name Vec(Unk0079)) Vec(Unk0079) := …

  # Check.ctor_types/2
  pub def ctor_types(types Vec(Type), prog Map(Unk0118, Vec(Unk0119))) Map(Unk0121, Unk0120) := …
  ...
  pub def opaque_table(prog Map(Unk0174, Vec(Unk0173))) Unk0175 := …
  ...
  # Check.program_ic/1
  pub def program_ic(p0 Map(Unk0022, Vec(Map(Unk0010, Vec(Unk0009))))) Map(Unk0081, Map(Vec(Unk0079), Vec(Unk0079))) := …
  ...
  # Comptime.int_div/3
  pub def int_div(_a Unk0197, p1 Int53, _op Fn(Unk0200, Unk0199, Unk0198)) Tuple(Unk0201, Int53) := …

  # Core.first_unsupported/2
  pub def first_unsupported(node Unk0202, unsup Map(Unk0204, Option(Unk0203))) Option(Unk0203) := …
  ...
  pub def reject_unsupported!(funcs Vec(Unk0212), unsup Map(Unk0204, Option(Unk0203)), target Symbol, exception Symbol) Symbol := …
  ...
  # Decl.attach_doc/2
  pub def attach_doc(p0 Tuple(Unk0225, Map(Unk0226, Bool)), doc Bool) Tuple(Unk0225, Map(Unk0226, Bool)) := …

  # Decl.attach_external/3
  pub def attach_external(p0 Unk0227, target Unk0228, spec Unk0229) Tuple(Unk0225, Map(Unk0226, Bool)) := …

  # Decl.attach_targets/2
  pub def attach_targets(p0 Unk0230, targets Unk0231) Tuple(Unk0225, Map(Unk0226, Bool)) := …
  ...
  pub def collect_macros(decls Vec(Unk0218)) Map(Unk0242, Unk0243) := …
  ...
  # Decl.mark_pub/1
  pub def mark_pub(p0 Unk0269) Tuple(Unk0225, Map(Unk0226, Bool)) := …

  # Decl.mark_test/1
  pub def mark_test(p0 Unk0270) Tuple(Unk0225, Map(Unk0226, Bool)) := …

  # Decl.meta_clause/5
  pub def meta_clause(p0 Unk0271, _env Map(Unk0242, Unk0243), _p Bool, _params Unk0238, _show Unk0272) Unk0273 := …
  ...
  pub def parse_assoc_binding(t Unk0284) Tuple(Unk0286, Option(Unk0285)) := …
  ...
  pub def proto_method_traits(prog Map(Unk0022, Vec(Map(Unk0010, Vec(Unk0009))))) Unk0318 := …
  ...
  pub def protocol_unit(prog Map(Unk0022, Vec(Map(Unk0010, Vec(Unk0009)))), types Vec(Map(Unk0010, Vec(Unk0009))), structs Vec(Map(Unk0010, Vec(Unk0009)))) Vec(Tuple(String, Unk0244)) := …
  ...
  # Decl.take_decl/1
  pub def take_decl(p0 Vec(Vec(Unk0232))) Tuple(Tuple(Unk0225, Map(Unk0226, Bool)), Vec(Unk0232)) := …
  ...
  pub def module_doc_strings(p0 Map(Unk0022, Vec(Map(Unk0010, Vec(Unk0009))))) Vec(Unk0362) := …
  ...
  pub def program_env(types Vec(Map(Unk0010, Vec(Unk0009))), structs Vec(Unk0391), ranges Vec(Unk0392)) Tuple(Unk0369, Map(String, String)) := …
  ...
  pub def bool_clause(p0 Unk0435) Tuple(Unk0437, Unk0436) := …
  ...
  # Infer.app/2
  pub def app(head String, args Vec(Vec(Unk0454))) Vec(Unk0454) := …

  # Infer.app1/2
  pub def app1(head String, s Tuple(Unk0455, Map(Unk0456, Vec(Unk0454)))) Tuple(Vec(Unk0454), Tuple(Unk0455, Map(Unk0456, Vec(Unk0454)))) := …

  # Infer.apply_spec_terms/4
  pub def apply_spec_terms(p0 Unk0457, _pvars Unk0458, _rvar Vec(Unk0454), store Tuple(Unk0455, Map(Unk0456, Vec(Unk0454)))) Tuple(Unk0455, Map(Unk0456, Vec(Unk0454))) := …

  # Infer.bind/3
  pub def bind(s Tuple(Unk0455, Map(Unk0456, Vec(Unk0454))), id Unk0456, t Vec(Unk0454)) Unk0459 := …

  # Infer.bind_checked/3
  pub def bind_checked(s Tuple(Unk0455, Map(Unk0456, Vec(Unk0454))), i Unk0456, t Vec(Unk0454)) Tuple(Tuple(Unk0455, Map(Unk0456, Vec(Unk0454))), Unk0460) := …

  # Infer.bind_params/3
  pub def bind_params(args Unk0461, pvars Unk0462, store Tuple(Unk0455, Map(Unk0456, Vec(Unk0454)))) Unk0463 := …

  # Infer.build_ctx/2
  pub def build_ctx(stdlib_map Unk0464, p1 Unk0465) Unk0466 := …

  # Infer.build_ledger/2
  pub def build_ledger(params Unk0467, ret String) Vec(Tuple(String, Unk0468)) := …

  # Infer.call_sig/6
  pub def call_sig(ctx Map(Unk0470, Map(Tuple(Unk0469, Int53), Unk0457)), key Unk0471, args Vec(Bool), env Map(String, Vec(Unk0454)), _outer Map(Unk0470, Map(Tuple(Unk0469, Int53), Unk0457)), s Tuple(Unk0455, Map(Unk0456, Vec(Unk0454)))) Tuple(Vec(Unk0454), Tuple(Unk0455, Map(Unk0456, Vec(Unk0454)))) := …

  # Infer.case_arm/1
  pub def case_arm(p0 Unk0472) Tuple(Unk0474, Option(Unk0473)) := …

  # Infer.clear_xmod/0
  pub def clear_xmod() Unk0475 := …

  # Infer.cluster_name/2
  pub def cluster_name(clusters Map(Tuple(Unk0469, Int53), Unk0457), struct String) String := …

  # Infer.collect_specs/1
  pub def collect_specs(stmts Vec(String)) Map(Tuple(Unk0469, Int53), Unk0457) := …

  # Infer.con/1
  pub def con(name String) Vec(Unk0454) := …

  # Infer.do_unify/3
  pub def do_unify(s Tuple(Unk0455, Map(Unk0456, Vec(Unk0454))), t Vec(Unk0454), t Vec(Unk0454)) Tuple(Tuple(Unk0455, Map(Unk0456, Vec(Unk0454))), Unk0460) := …

  # Infer.free_vars/2
  pub def free_vars(store Tuple(Unk0455, Map(Unk0456, Vec(Unk0454))), t Vec(Unk0454)) Vec(Unk0476) := …

  # Infer.fresh/1
  pub def fresh(s Tuple(Unk0455, Map(Unk0456, Vec(Unk0454)))) Tuple(Vec(Unk0454), Tuple(Unk0455, Map(Unk0456, Vec(Unk0454)))) := …

  # Infer.fresh_n/2
  pub def fresh_n(s Tuple(Unk0455, Map(Unk0456, Vec(Unk0454))), k Int53) Tuple(Vec(Unk0477), Tuple(Unk0455, Map(Unk0456, Vec(Unk0454)))) := …

  # Infer.fresh_num/1
  pub def fresh_num(s Tuple(Unk0455, Map(Unk0456, Vec(Unk0454)))) Tuple(Vec(Unk0454), Tuple(Unk0455, Map(Unk0456, Vec(Unk0454)))) := …

  # Infer.freshen_tvars/2
  pub def freshen_tvars(tvars Vec(Unk0478), s Tuple(Unk0455, Map(Unk0456, Vec(Unk0454)))) Tuple(Map(Unk0478, Unk0479), Tuple(Unk0455, Map(Unk0456, Vec(Unk0454)))) := …

  # Infer.gen/4
  pub def gen(n Bool, _env Map(String, Vec(Unk0454)), _ctx Map(Unk0470, Map(Tuple(Unk0469, Int53), Unk0457)), s Tuple(Unk0455, Map(Unk0456, Vec(Unk0454)))) Tuple(Vec(Unk0454), Tuple(Unk0455, Map(Unk0456, Vec(Unk0454)))) := …

  # Infer.gen_args_then_fresh/4
  pub def gen_args_then_fresh(args Vec(Bool), env Map(String, Vec(Unk0454)), ctx Map(Unk0470, Map(Tuple(Unk0469, Int53), Unk0457)), s Tuple(Unk0455, Map(Unk0456, Vec(Unk0454)))) Tuple(Vec(Unk0454), Tuple(Unk0455, Map(Unk0456, Vec(Unk0454)))) := …

  # Infer.gen_block/4
  pub def gen_block(p0 Vec(Bool), _env Map(String, Vec(Unk0454)), _ctx Map(Unk0470, Map(Tuple(Unk0469, Int53), Unk0457)), s Tuple(Unk0455, Map(Unk0456, Vec(Unk0454)))) Tuple(Vec(Unk0454), Tuple(Unk0455, Map(Unk0456, Vec(Unk0454)))) := …

  # Infer.gen_cons/5
  pub def gen_cons(h Bool, t Bool, env Map(String, Vec(Unk0454)), ctx Map(Unk0470, Map(Tuple(Unk0469, Int53), Unk0457)), s Tuple(Unk0455, Map(Unk0456, Vec(Unk0454)))) Tuple(Vec(Unk0454), Tuple(Unk0455, Map(Unk0456, Vec(Unk0454)))) := …

  # Infer.gen_pat/4
  pub def gen_pat(p0 Vec(Unk0480), pv Vec(Unk0454), env Map(String, Vec(Unk0454)), s Tuple(Unk0455, Map(Unk0456, Vec(Unk0454)))) Tuple(Map(String, Vec(Unk0454)), Tuple(Unk0455, Map(Unk0456, Vec(Unk0454)))) := …

  # Infer.gen_pat_cons/5
  pub def gen_pat_cons(h Vec(Unk0480), t Vec(Unk0480), pv Vec(Unk0454), env Map(String, Vec(Unk0454)), s Tuple(Unk0455, Map(Unk0456, Vec(Unk0454)))) Tuple(Map(String, Vec(Unk0454)), Tuple(Unk0455, Map(Unk0456, Vec(Unk0454)))) := …

  # Infer.generalize_map/3
  pub def generalize_map(pvars Unk0481, rvar Vec(Unk0454), store Tuple(Unk0455, Map(Unk0456, Vec(Unk0454)))) Map(Unk0482, Unk0483) := …
  ...
  # Infer.infer_group/2
  pub def infer_group(p0 Unk0486, ctx Map(Unk0470, Map(Tuple(Unk0469, Int53), Unk0457))) Unk0485 := …

  # Infer.instantiate/5
  pub def instantiate(p0 Unk0487, args Vec(Bool), env Map(String, Vec(Unk0454)), ctx Map(Unk0470, Map(Tuple(Unk0469, Int53), Unk0457)), s Tuple(Unk0455, Map(Unk0456, Vec(Unk0454)))) Tuple(Vec(Unk0454), Tuple(Unk0455, Map(Unk0456, Vec(Unk0454)))) := …

  # Infer.load_prelude_sigs/0
  pub def load_prelude_sigs() Unk0488 := …

  # Infer.mark_num/2
  pub def mark_num(s Tuple(Unk0455, Map(Unk0456, Vec(Unk0454))), t Vec(Unk0454)) Tuple(Tuple(Unk0455, Map(Unk0456, Vec(Unk0454))), Unk0489) := …

  # Infer.max_ph/1
  pub def max_ph(p0 Vec(Unk0490)) Int53 := …

  # Infer.maybe_tuple/4
  pub def maybe_tuple(elems Vec(Unk0491), env Map(String, Vec(Unk0454)), ctx Map(Unk0470, Map(Tuple(Unk0469, Int53), Unk0457)), s Tuple(Unk0455, Map(Unk0456, Vec(Unk0454)))) Tuple(Vec(Unk0454), Tuple(Unk0455, Map(Unk0456, Vec(Unk0454)))) := …

  # Infer.mod_name/1
  pub def mod_name(p0 Unk0492) String := …

  # Infer.num_conflict?/3
  pub def num_conflict?(s Tuple(Unk0455, Map(Unk0456, Vec(Unk0454))), i Unk0456, t Vec(Unk0454)) Bool := …

  # Infer.numeric_con?/1
  pub def numeric_con?(p0 Vec(Unk0454)) Bool := …

  # Infer.occurs?/3
  pub def occurs?(s Tuple(Unk0455, Map(Unk0456, Vec(Unk0454))), i Unk0456, t Vec(Unk0454)) Bool := …

  # Infer.ok_payload/3
  pub def ok_payload(tail_pairs Vec(Unk0493), ctx Map(Unk0470, Map(Tuple(Unk0469, Int53), Unk0457)), store Unk0494) Unk0495 := …

  # Infer.parse_type/2
  pub def parse_type(str Unk0496, fmap Map(Unk0497, Unk0498)) Vec(Unk0454) := …

  # Infer.prelude_sigs/0
  pub def prelude_sigs() Unk0488 := …

  # Infer.prime_xmod/2
  pub def prime_xmod(modules Unk0499, stdlib_map Unk0500) Unk0501 := …

  # Infer.put_slot/3
  pub def put_slot(sig Tuple(Unk0502, String), p1 String, ts String) Unk0503 := …

  # Infer.render/3
  pub def render(store Tuple(Unk0455, Map(Unk0456, Vec(Unk0454))), gmap Map(Unk0482, Unk0483), t Vec(Unk0454)) String := …

  # Infer.render_wp/3
  pub def render_wp(store Tuple(Unk0455, Map(Unk0456, Vec(Unk0454))), unk_names Map(Unk0504, String), t Vec(Unk0454)) String := …

  # Infer.resolve/2
  pub def resolve(s Tuple(Unk0455, Map(Unk0456, Vec(Unk0454))), p1 Vec(Unk0454)) Vec(Unk0454) := …

  # Infer.resolve_program/2
  pub def resolve_program(sigvars Vec(Unk0505), store Tuple(Unk0455, Map(Unk0456, Vec(Unk0454)))) Unk0506 := …

  # Infer.resolve_struct_params/4
  pub def resolve_struct_params(args Unk0507, pvars Unk0508, ctx Map(Unk0470, Map(Tuple(Unk0469, Int53), Unk0457)), s Tuple(Unk0455, Map(Unk0456, Vec(Unk0454)))) Tuple(Unk0455, Map(Unk0456, Vec(Unk0454))) := …

  # Infer.result_analysis/3
  pub def result_analysis(clause_envs Vec(Unk0509), ctx Map(Unk0470, Map(Tuple(Unk0469, Int53), Unk0457)), store Unk0494) Unk0510 := …

  # Infer.result_tag/1
  pub def result_tag(p0 Unk0511) Tuple(Unk0512, Unk0513) := …

  # Infer.seed_spec/6
  pub def seed_spec(ctx Map(Unk0470, Map(Tuple(Unk0469, Int53), Unk0457)), name Unk0469, arity Int53, pvars Unk0458, rvar Vec(Unk0454), store Tuple(Unk0455, Map(Unk0456, Vec(Unk0454)))) Tuple(Unk0455, Map(Unk0456, Vec(Unk0454))) := …

  # Infer.sig_of/1
  pub def sig_of(f Unk0514) Unk0515 := …

  # Infer.sigvar_call/5
  pub def sigvar_call(ctx Map(Unk0470, Map(Tuple(Unk0469, Int53), Unk0457)), key Unk0516, args Unk0517, env Map(String, Vec(Unk0454)), s Tuple(Unk0455, Map(Unk0456, Vec(Unk0454)))) Unk0518 := …

  # Infer.slot_sig/3
  pub def slot_sig(p0 String, ts String, _ Vec(Unk0519)) Unk0520 := …

  # Infer.spec_pair/1
  pub def spec_pair(p0 Unk0521) Tuple(Tuple(Unk0523, Unk0522), Unk0524) := …

  # Infer.spec_str/1
  pub def spec_str(p0 Unk0525) String := …

  # Infer.store_new/0
  pub def store_new() Tuple(Unk0455, Map(Unk0456, Vec(Unk0454))) := …

  # Infer.translate_spec/1
  pub def translate_spec(p0 Vec(Unk0526)) Vec(Unk0454) := …

  # Infer.tvar?/1
  pub def tvar?(s Unk0497) Unk0527 := …

  # Infer.tvar_name/1
  pub def tvar_name(i Unk0528) Unk0529 := …

  # Infer.unify/3
  pub def unify(s Tuple(Unk0455, Map(Unk0456, Vec(Unk0454))), a Vec(Unk0454), b Vec(Unk0454)) Tuple(Tuple(Unk0455, Map(Unk0456, Vec(Unk0454))), Unk0460) := …

  # Infer.union_spec/2
  pub def union_spec(a Vec(Unk0526), b Vec(Unk0526)) Vec(Unk0454) := …

  # Infer.unk_vars/2
  pub def unk_vars(store Tuple(Unk0455, Map(Unk0456, Vec(Unk0454))), v Vec(Unk0454)) Vec(Unk0530) := …

  # Infer.vec_spec/1
  pub def vec_spec(elem Unk0526) Vec(Unk0454) := …

  # Infer.whole_program/4
  pub def whole_program(modules Vec(Tuple(String, Vec(Unk0531))), stdlib Unk0532, p2 Unk0533, p3 Unk0534) Unk0506 := …

  # Infer.xmod_cache/0
  pub def xmod_cache() Unk0535 := …

  # Interp.concat_chain/1
  pub def concat_chain(parts Vec(Tuple(Unk0536, String))) Tuple(Unk0536, String) := …
  ...
  pub def resolve_part(p0 Unk0537, _env Map(Unk0086, Vec(Unk0079)), _ic Map(Unk0081, Map(Vec(Unk0079), Vec(Unk0079))), _show Unk0272) Tuple(Unk0538, Unk0539) := …

  # Interp.stringify/3
  pub def stringify(expr Option(Unk0017), p1 Vec(Unk0079), _show Unk0272) Tuple(Unk0538, Unk0539) := …

  # JS.all_funcs/1
  pub def all_funcs(prog Map(Unk0540, Vec(Unk0541))) Vec(Unk0541) := …

  # JS.arm_return/3
  pub def arm_return(body Unk0542, p1 Unk0543, i53 Bool) String := …

  # JS.bind_lines/1
  pub def bind_lines(binds Vec(Unk0544)) Vec(String) := …

  # JS.block_return/2
  pub def block_return(p0 Vec(Unk0545), i53 Bool) String := …

  # JS.branch_js/2
  pub def branch_js(p0 Sum1, i53 Bool) String := …

  # JS.case_arm_js/2
  pub def case_arm_js(p0 Unk0546, i53 Bool) String := …

  # JS.clause_js/2
  pub def clause_js(p0 Unk0547, i53 Bool) String := …

  # JS.clause_return/3
  pub def clause_return(src Option(Unk0017), params Vec(Unk0548), i53 Bool) String := …

  # JS.cp_lit/2
  pub def cp_lit(cp Unk0549, i53 Bool) String := …

  # JS.dispatcher_js/5
  pub def dispatcher_js(proto Unk0550, method Unk0551, impl_types Vec(Unk0552), reg Unk0553, i53 Bool) String := …

  # JS.expr_js/2
  pub def expr_js(p0 Sum1, i53 Bool) String := …

  # JS.float?/1
  pub def float?(n Unk0554) Bool := …

  # JS.function_js/2
  pub def function_js(p0 Unk0212, _i53 Bool) String := …

  # JS.guarded_return/4
  pub def guarded_return(body Option(Unk0017), p1 Unk0555, params Vec(Unk0548), i53 Bool) String := …

  # JS.js_atom/1
  pub def js_atom(name Unk0556) String := …

  # JS.js_guard!/4
  pub def js_guard!(type String, proto Unk0557, reg Unk0558, i53 Unk0559) Unk0560 := …

  # JS.js_number_int?/1
  pub def js_number_int?(t Unk0561) Bool := …

  # JS.js_str/1
  pub def js_str(s Unk0556) String := …

  # JS.lit_js/2
  pub def lit_js(v Unk0556, i53 Bool) String := …

  # JS.mangle/3
  pub def mangle(proto Unk0562, type Unk0563, method Unk0564) String := …

  # JS.match_elems/3
  pub def match_elems(es Unk0565, acc String, i53 Bool) Unk0566 := …

  # JS.num_js/2
  pub def num_js(n Unk0554, i53 Bool) String := …

  # JS.paren/2
  pub def paren(e Unk0567, i53 Unk0568) String := …

  # JS.pascal?/1
  pub def pascal?(s Unk0569) Bool := …

  # JS.pat_match/3
  pub def pat_match(p0 Sum2, _acc String, _i53 Bool) Tuple(Vec(String), Vec(Tuple(Unk0570, String))) := …
  ...
  pub def reject_mixed_int_mode!(prog Map(Unk0033, Vec(Map(Unk0010, Vec(Unk0009))))) Unk0571 := …

  # JS.reject_wide_int!/2
  pub def reject_wide_int!(name Unk0572, p1 Unk0573) Unk0574 := …

  # JS.stmt_js/2
  pub def stmt_js(p0 Unk0575, i53 Bool) String := …

  # JS.stmt_return/2
  pub def stmt_return(p0 Unk0576, i53 Unk0577) String := …

  # JS.struct_name_set/1
  pub def struct_name_set(prog Map(Unk0033, Vec(Map(Unk0010, Vec(Unk0009))))) Unk0578 := …

  # JS.sum_ctor_map/1
  pub def sum_ctor_map(prog Map(Unk0033, Vec(Map(Unk0010, Vec(Unk0009))))) Unk0579 := …

  # JS.sum_guard_js/1
  pub def sum_guard_js(ctors Vec(Unk0580)) String := …

  # JVM.all_funcs/1
  pub def all_funcs(prog Map(Unk0581, Vec(Unk0582))) Vec(Unk0582) := …

  # JVM.all_types/1
  pub def all_types(prog Map(Unk0033, Vec(Map(Unk0010, Vec(Unk0009))))) Vec(Map(Unk0010, Vec(Unk0009))) := …

  # JVM.bind_str/1
  pub def bind_str(p0 Vec(Unk0583)) String := …

  # JVM.block_value/1
  pub def block_value(p0 Vec(Unk0545)) String := …

  # JVM.branch_kt/1
  pub def branch_kt(p0 Sum1) String := …

  # JVM.case_arms/2
  pub def case_arms(arms Unk0584, acc String) Tuple(Vec(Unk0586), Unk0585) := …

  # JVM.clause_lines/1
  pub def clause_lines(p0 Vec(Unk0587)) Tuple(String, Bool) := …

  # JVM.clause_match/1
  pub def clause_match(pats Unk0588) Unk0589 := …

  # JVM.clause_value/2
  pub def clause_value(src Option(Unk0017), params Vec(Unk0548)) String := …

  # JVM.closed_or_cond/3
  pub def closed_or_cond(p0 Vec(Unk0590), line String, _rest Vec(Unk0587)) Tuple(String, Bool) := …

  # JVM.expr_kt/1
  pub def expr_kt(p0 Sum1) String := …

  # JVM.function_kt/1
  pub def function_kt(p0 Unk0591) String := …

  # JVM.guarded_arm/2
  pub def guarded_arm(body_kt String, p1 Unk0592) String := …

  # JVM.guarded_return/3
  pub def guarded_return(body Unk0593, p1 Unk0594, params Vec(Unk0595)) String := …

  # JVM.kotlin_module/2
  pub def kotlin_module(src String, p1 Unk0596) String := …

  # JVM.kt_str/1
  pub def kt_str(s Unk0597) String := …

  # JVM.kt_type/1
  pub def kt_type(p0 String) Unk0598 := …

  # JVM.lit_kt/1
  pub def lit_kt(v Unk0597) String := …

  # JVM.pat_match/2
  pub def pat_match(p0 Sum2, _acc String) Tuple(Vec(String), Vec(Tuple(Unk0599, String))) := …

  # JVM.prepend_if/3
  pub def prepend_if(tests Vec(Unk0590), line String, rest Vec(Unk0587)) Tuple(String, Bool) := …

  # JVM.run_or_cond/3
  pub def run_or_cond(p0 Vec(Unk0590), line String, rest Vec(Unk0587)) Tuple(String, Bool) := …

  # JVM.stmt_kt/1
  pub def stmt_kt(p0 Unk0600) String := …

  # JVM.stmt_value/1
  pub def stmt_value(p0 Unk0601) String := …

  # JVM.sum_decl/1
  pub def sum_decl(t Unk0602) String := …

  # JVM.to_jar/3
  pub def to_jar(src String, jar_path String, p2 Unk0603) Unk0604 := …

  # JVM.variant_decl/2
  pub def variant_decl(p0 Unk0605, tname Unk0606) String := …

  # Lexer.binify/1
  pub def binify(acc Vec(String)) Unk0607 := …

  # Lexer.capture_hole/3
  pub def capture_hole(p0 String, _d Int53, _acc Vec(String)) Tuple(Unk0607, Unk0608) := …

  # Lexer.char_escape/1
  pub def char_escape(p0 Unk0609) Tuple(Int53, Unk0610) := …

  # Lexer.close_char/1
  pub def close_char(p0 String) Unk0611 := …

  # Lexer.collapse_nl/1
  pub def collapse_nl(tokens Unk0612) Unk0613 := …

  # Lexer.detokenize/2
  pub def detokenize(tokens Unk0614, p1 String) String := …

  # Lexer.escape_str/1
  pub def escape_str(s Unk0615) String := …

  # Lexer.expr_tokens/1
  pub def expr_tokens(src String) Vec(Vec(Vec(Unk0616))) := …

  # Lexer.lex/2
  pub def lex(str String, acc Vec(Tuple(Unk0617, String))) Unk0618 := …

  # Lexer.lex_char/1
  pub def lex_char(p0 String) Tuple(Unk0619, Unk0611) := …

  # Lexer.lex_parts/3
  pub def lex_parts(p0 String, _lit Vec(String), _parts Vec(Tuple(Unk0620, Unk0607))) Tuple(Vec(Tuple(Unk0620, Unk0607)), Unk0621) := …

  # Lexer.lex_string_token/1
  pub def lex_string_token(str String) Tuple(Tuple(Unk0624, Vec(Unk0622)), Unk0623) := …

  # Lexer.parse_hex!/1
  pub def parse_hex!(hex Unk0610) Int53 := …

  # Lexer.punct/1
  pub def punct(str String) Option(Unk0625) := …

  # Lexer.string_token/1
  pub def string_token(parts Vec(Unk0622)) Tuple(Unk0624, Vec(Unk0622)) := …

  # Lexer.strip_trivia/1
  pub def strip_trivia(tokens Unk0626) Unk0627 := …

  # Lexer.take_comment/1
  pub def take_comment(str String) Tuple(Unk0628, String) := …

  # Lexer.take_hex/2
  pub def take_hex(str Unk0629, max Int53) Tuple(String, Unk0629) := …

  # Lexer.take_hex/3
  pub def take_hex(p0 Unk0629, max Int53, acc String) Tuple(String, Unk0629) := …

  # Lexer.tok_str/2
  pub def tok_str(p0 Unk0630, nl_as String) String := …

  # Lexer.tokenize/1
  pub def tokenize(src String) Unk0631 := …

  # Lexer.tokenize_trivia/1
  pub def tokenize_trivia(src String) Unk0618 := …

  # Lexer.word/1
  pub def word(w String) Tuple(Unk0617, String) := …

  # Livebook.eval/1
  pub def eval(source String) Unk0632 := …

  # Livebook.output/1
  pub def output(p0 Vec(String)) Unk0632 := …

  # Livebook.run/2
  pub def run(session Unk0633, source String) Tuple(Unk0634, Unk0633) := …

  # Livebook.session_pid/0
  pub def session_pid() Unk0635 := …

  # Lower.add_list_elem_vars/2
  pub def add_list_elem_vars(acc Unk0636, p1 Unk0637) Unk0636 := …

  # Lower.add_var/2
  pub def add_var(acc Unk0636, p1 Unk0638) Unk0636 := …

  # Lower.all_pat_vars/1
  pub def all_pat_vars(p0 Sum2) Vec(Unk0639) := …

  # Lower.arm_rebinds/3
  pub def arm_rebinds(pats Unk0640, iso Unk0641, used Unk0642) Vec(Unk0643) := …

  # Lower.assoc/1
  pub def assoc(op String) Unk0644 := …

  # Lower.body_ast/2
  pub def body_ast(src Unk0645, ctx Unk0646) Unk0647 := …

  # Lower.borrow_arg/5
  pub def borrow_arg(a Tuple(Unk0196, String), pt String, funs Map(Unk0649, Unk0648), borrowed Bool, ec Unk0650) Unk0651 := …
  ...
  pub def borrowed_in_pat(p0 Sum2, p1 Bool) Vec(Unk0652) := …

  # Lower.borrowed_vars/2
  pub def borrowed_vars(params Unk0653, pats Unk0654) Option(Unk0655) := …

  # Lower.build_env/3
  pub def build_env(types Vec(Map(Unk0010, Vec(Unk0009))), structs Vec(Unk0656), ranges Vec(Unk0657)) Unk0658 := …

  # Lower.build_meta/1
  pub def build_meta(types Vec(Map(Unk0010, Vec(Unk0009)))) Unk0659 := …

  # Lower.build_struct_meta/1
  pub def build_struct_meta(structs Vec(Map(Unk0010, Vec(Unk0009)))) Unk0660 := …

  # Lower.cap_arity/1
  pub def cap_arity(p0 Sum1) Int53 := …

  # Lower.case_guard/3
  pub def case_guard(p0 Option(Unk0017), _ Unk0661, _ec Tuple(Unk0662, Unk0663)) String := …

  # Lower.catchall_pat?/1
  pub def catchall_pat?(p0 Sum2) Bool := …

  # Lower.char_vars/2
  pub def char_vars(params Unk0664, pats Unk0665) Unk0666 := …

  # Lower.check!/2
  pub def check!(p0 Map(Unk0667, Vec(Unk0009)), _env Unk0658) Unk0668 := …

  # Lower.coerce_string_ast/2
  pub def coerce_string_ast(p0 Option(Unk0017), ec Tuple(Unk0662, Unk0663)) String := …

  # Lower.coerce_string_branch/2
  pub def coerce_string_branch(p0 Option(Unk0017), ec Tuple(Unk0662, Unk0663)) String := …

  # Lower.collect_ids/2
  pub def collect_ids(p0 Vec(Unk0669), acc Unk0642) Unk0642 := …

  # Lower.collect_owned_field_vars/3
  pub def collect_owned_field_vars(p0 Unk0670, ctx Map(Unk0672, Unk0671), acc Unk0673) Unk0673 := …

  # Lower.compile/5
  pub def compile(types Vec(Map(Unk0010, Vec(Unk0009))), func Map(Unk0667, Vec(Unk0009)), p2 Unk0674, p3 Unk0675, p4 Unk0318) Unk0244 := …

  # Lower.compile_beam/4
  pub def compile_beam(types Vec(Map(Unk0010, Vec(Unk0009))), func Map(Unk0667, Vec(Unk0009)), p2 Unk0676, p3 Unk0677) Unk0244 := …

  # Lower.compile_elixir/4
  pub def compile_elixir(types Vec(Map(Unk0010, Vec(Unk0009))), func Map(Unk0667, Vec(Unk0009)), p2 Unk0678, p3 Unk0679) Unk0244 := …

  # Lower.compile_module/1
  pub def compile_module(p0 Unk0680) Unk0244 := …

  # Lower.compile_module_beam/1
  pub def compile_module_beam(p0 Unk0681) Unk0244 := …

  # Lower.cons_tail_names/1
  pub def cons_tail_names(p0 Sum2) Vec(Unk0682) := …

  # Lower.cons_tail_rebinds/1
  pub def cons_tail_rebinds(p0 Sum2) Vec(String) := …

  # Lower.const_set/1
  pub def const_set(consts Vec(Unk0683)) Unk0684 := …

  # Lower.core_pat_ex/1
  pub def core_pat_ex(surface Sum2) String := …

  # Lower.core_pat_rs/2
  pub def core_pat_rs(surface Sum2, meta Unk0685) String := …

  # Lower.core_pat_vars/1
  pub def core_pat_vars(p0 Sum2) Vec(Unk0686) := …

  # Lower.ctx/4
  pub def ctx(meta Unk0659, smeta Unk0660, cset Unk0684, p3 Unk0687) Map(Unk0672, Unk0671) := …

  # Lower.deref_ids/2
  pub def deref_ids(ast Tuple(Unk0688, String), p1 Vec(Unk0689)) Tuple(Unk0688, String) := …

  # Lower.disp/2
  pub def disp(p0 String, p1 Unk0661) String := …

  # Lower.elixir_clauses/3
  pub def elixir_clauses(func Map(Unk0667, Vec(Unk0009)), ctx Unk0690, def_kw String) String := …

  # Lower.emit/3
  pub def emit(p0 Option(Unk0017), _t Unk0661, _ec Tuple(Unk0662, Unk0663)) Tuple(String, Int53) := …

  # Lower.emit_ast/2
  pub def emit_ast(ast Option(Unk0017), target Unk0661) Unk0691 := …

  # Lower.emit_block/3
  pub def emit_block(p0 Sum1, p1 Unk0661, _ec Tuple(Unk0662, Unk0663)) String := …

  # Lower.emit_ctx/1
  pub def emit_ctx(p0 Unk0692) Tuple(Unk0694, Unk0693) := …

  # Lower.emit_expr/2
  pub def emit_expr(src String, target Unk0661) Unk0695 := …

  # Lower.enum_generics/2
  pub def enum_generics(name Unk0696, parametric Map(Unk0696, Vec(Unk0697))) String := …

  # Lower.ex_const/2
  pub def ex_const(c Unk0683, ctx Unk0690) String := …

  # Lower.ex_doc/2
  pub def ex_doc(p0 Vec(Unk0009), _attr String) String := …

  # Lower.ex_struct/1
  pub def ex_struct(s Unk0698) String := …

  # Lower.ex_typespec/1
  pub def ex_typespec(t Map(Unk0699, Vec(Unk0009))) String := …

  # Lower.ex_use/1
  pub def ex_use(p0 Unk0700) String := …

  # Lower.flatten_concat/1
  pub def flatten_concat(p0 Sum1) Vec(Sum1) := …

  # Lower.fn_all_tvars/3
  pub def fn_all_tvars(func Map(Unk0667, Vec(Unk0009)), pinst Unk0701, ec Tuple(Unk0703, Unk0702)) Vec(Unk0009) := …

  # Lower.guard_kw/1
  pub def guard_kw(p0 Unk0661) String := …

  # Lower.guard_str/4
  pub def guard_str(c Map(Unk0704, String), target Unk0661, ec Tuple(Unk0662, Unk0663), p3 Unk0705) String := …

  # Lower.impl_param/2
  pub def impl_param(p0 Unk0706, rust_type String) String := …

  # Lower.infer_concrete_params/3
  pub def infer_concrete_params(func Map(Unk0667, Vec(Unk0009)), params Vec(Unk0707), ec Tuple(Unk0703, Unk0702)) Vec(String) := …

  # Lower.infer_tvar_binding/2
  pub def infer_tvar_binding(p0 Unk0708, ec Unk0709) Unk0710 := …

  # Lower.insert_borrows/4
  pub def insert_borrows(p0 Option(Unk0017), funs Map(Unk0649, Unk0648), ec Unk0650, borrowed Bool) Tuple(Unk0196, String) := …

  # Lower.iso_cons_positions/1
  pub def iso_cons_positions(func Map(Unk0667, Vec(Unk0009))) Unk0641 := …

  # Lower.list_rpat?/1
  pub def list_rpat?(p0 Unk0711) Bool := …

  # Lower.member_scan/3
  pub def member_scan(p0 Vec(Unk0712), _name Vec(Unk0713), _prev Bool) Bool := …

  # Lower.module_elixir/1
  pub def module_elixir(p0 Unk0714) String := …

  # Lower.module_rust/1
  pub def module_rust(p0 Unk0715) String := …

  # Lower.ofb/3
  pub def ofb(p0 Vec(Unk0716), ctx Map(Unk0672, Unk0671), acc Unk0673) Unk0673 := …

  # Lower.owned_arg?/2
  pub def owned_arg?(p0 Tuple(Unk0196, String), _funs Map(Unk0649, Unk0648)) Bool := …

  # Lower.owned_field_binders/2
  pub def owned_field_binders(ast Vec(Unk0716), ctx Map(Unk0672, Unk0671)) Unk0673 := …

  # Lower.owned_field_var?/2
  pub def owned_field_var?(p0 Tuple(Unk0196, String), ec Unk0650) Bool := …

  # Lower.owned_scrut?/2
  pub def owned_scrut?(p0 Unk0717, _ctx Map(Unk0672, Unk0671)) Bool := …

  # Lower.owned_str_arg/1
  pub def owned_str_arg(s Unk0718) Unk0719 := …

  # Lower.p/4
  pub def p(node Option(Unk0017), ctx Int53, t Unk0661, ec Tuple(Unk0662, Unk0663)) String := …

  # Lower.pair_inst/2
  pub def pair_inst(func Map(Unk0667, Vec(Unk0009)), ec Tuple(Unk0703, Unk0702)) Unk0701 := …

  # Lower.param_rtypes/2
  pub def param_rtypes(name Unk0649, funs Map(Unk0649, Unk0648)) Vec(String) := …

  # Lower.parametric_param_map/1
  pub def parametric_param_map(types Vec(Map(Unk0010, Vec(Unk0009)))) Unk0720 := …

  # Lower.parametric_used?/2
  pub def parametric_used?(func Map(Unk0667, Vec(Unk0009)), name Unk0721) Bool := …

  # Lower.pascal?/1
  pub def pascal?(s Unk0722) Bool := …

  # Lower.pat_ex/1
  pub def pat_ex(p0 Sum2) String := …

  # Lower.pat_rs/2
  pub def pat_rs(p0 Sum2, _ Unk0685) String := …

  # Lower.pipe_to_call/2
  pub def pipe_to_call(l Unk0723, p1 Sum1) Sum1 := …

  # Lower.proto_method_traits/1
  pub def proto_method_traits(protocols Vec(Map(Unk0010, Vec(Unk0009)))) Unk0724 := …

  # Lower.pub_sig_type_names/1
  pub def pub_sig_type_names(funcs Unk0725) Unk0726 := …

  # Lower.ref_type/2
  pub def ref_type(p0 String, self_repr Unk0727) String := …

  # Lower.resolve_consts/2
  pub def resolve_consts(p0 Option(Unk0017), cset Unk0728) Tuple(Unk0196, String) := …

  # Lower.resolve_rust_pats/2
  pub def resolve_rust_pats(p0 Option(Unk0017), meta Unk0685) Tuple(Unk0196, String) := …

  # Lower.resolve_structs/2
  pub def resolve_structs(p0 Option(Unk0017), smeta Unk0729) Tuple(Unk0196, String) := …

  # Lower.resolve_variants/2
  pub def resolve_variants(p0 Option(Unk0017), meta Map(Unk0731, Option(Unk0730))) Tuple(Unk0196, String) := …

  # Lower.rest_pat_rs/1
  pub def rest_pat_rs(p0 Sum2) String := …

  # Lower.result_parts/1
  pub def result_parts(ret String) Tuple(Unk0732, String) := …

  # Lower.result_payload/3
  pub def result_payload(val Option(Unk0017), string? Bool, ec Tuple(Unk0662, Unk0663)) String := …

  # Lower.rewrite_proto_calls/2
  pub def rewrite_proto_calls(p0 Vec(Unk0733), methods Unk0734) Vec(Unk0733) := …
  ...
  # Lower.rust_case/4
  pub def rust_case(scrut Option(Unk0017), arms Vec(Unk0735), body_fn Fn(Option(Unk0017), String), ec Tuple(Unk0662, Unk0663)) String := …

  # Lower.rust_const/2
  pub def rust_const(c Unk0683, ctx Map(Unk0672, Unk0671)) String := …

  # Lower.rust_enum/3
  pub def rust_enum(t Map(Unk0010, Vec(Unk0009)), p1 String, p2 Unk0720) String := …

  # Lower.rust_fn/4
  pub def rust_fn(p0 Map(Unk0667, Vec(Unk0009)), _ctx Map(Unk0672, Unk0671), vis String, _base_ec Tuple(Unk0694, Unk0693)) String := …

  # Lower.rust_generics/1
  pub def rust_generics(p0 Unk0736) String := …

  # Lower.rust_impl/4
  pub def rust_impl(p0 Map(Unk0010, Vec(Unk0009)), protocols Vec(Map(Unk0010, Vec(Unk0009))), c Map(Unk0672, Unk0671), base_ec Tuple(Unk0694, Unk0693)) String := …

  # Lower.rust_impl_method/6
  pub def rust_impl_method(method Unk0737, sig Unk0738, rust_type String, c Map(Unk0672, Unk0671), copy_recv? Bool, base_ec Tuple(Unk0694, Unk0693)) String := …

  # Lower.rust_lit_type/1
  pub def rust_lit_type(p0 Unk0739) String := …

  # Lower.rust_owned_elem/2
  pub def rust_owned_elem(p0 Option(Unk0017), ec Tuple(Unk0662, Unk0663)) String := …

  # Lower.rust_program/1
  pub def rust_program(prog Map(Unk0022, Vec(Map(Unk0010, Vec(Unk0009))))) String := …

  # Lower.rust_proto_body/3
  pub def rust_proto_body(src Unk0740, c Map(Unk0741, Unk0742), ec Unk0743) Unk0744 := …

  # Lower.rust_protocols/4
  pub def rust_protocols(protocols Vec(Map(Unk0010, Vec(Unk0009))), impl_decls Vec(Map(Unk0010, Vec(Unk0009))), types Vec(Map(Unk0010, Vec(Unk0009))), structs Vec(Map(Unk0010, Vec(Unk0009)))) Unk0745 := …

  # Lower.rust_scrut/2
  pub def rust_scrut(params Unk0746, iso Unk0641) String := …

  # Lower.rust_struct/2
  pub def rust_struct(s Unk0747, p1 Unk0748) String := …

  # Lower.rust_total_shim?/1
  pub def rust_total_shim?(func Map(Unk0667, Vec(Unk0009))) Bool := …

  # Lower.rust_trait/1
  pub def rust_trait(p0 Unk0749) String := …

  # Lower.rust_use/1
  pub def rust_use(p0 Unk0750) String := …

  # Lower.rustify_parametric/2
  pub def rustify_parametric(rust_type String, pinst Vec(Unk0751)) String := …

  # Lower.scalar_literal?/1
  pub def scalar_literal?(p0 Tuple(Unk0196, String)) Bool := …

  # Lower.sig_param/2
  pub def sig_param(p String, self_repr Unk0752) String := …

  # Lower.slice_binders/2
  pub def slice_binders(params Unk0753, pats Vec(Sum2)) Unk0673 := …

  # Lower.slice_elem_vars/1
  pub def slice_elem_vars(p0 Sum2) Vec(Unk0754) := …

  # Lower.slice_var?/2
  pub def slice_var?(p0 Sum1, ec Tuple(Unk0662, Unk0663)) Bool := …

  # Lower.str_lit/1
  pub def str_lit(s Unk0755) String := …

  # Lower.strip_prefix/2
  pub def strip_prefix(rest Vec(Unk0756), p1 Vec(Unk0713)) Tuple(Unk0757, Vec(Unk0756)) := …

  # Lower.struct_pairs/4
  pub def struct_pairs(name Unk0758, labels Vec(Unk0759), args Vec(Option(Unk0017)), smeta Unk0729) Unk0760 := …

  # Lower.subst_assoc/2
  pub def subst_assoc(t String, assoc_rust Vec(Unk0761)) String := …

  # Lower.tail_expr/1
  pub def tail_expr(p0 Unk0762) Unk0762 := …

  # Lower.tail_slice_id?/2
  pub def tail_slice_id?(p0 Option(Unk0017), ec Tuple(Unk0662, Unk0663)) Bool := …

  # Lower.to_elixir/4
  pub def to_elixir(func Map(Unk0667, Vec(Unk0009)), types Vec(Map(Unk0010, Vec(Unk0009))), p2 Unk0763, p3 Unk0660) Unk0764 := …

  # Lower.to_rust/6
  pub def to_rust(func Map(Unk0667, Vec(Unk0009)), types Vec(Map(Unk0010, Vec(Unk0009))), meta Unk0659, p3 Unk0765, p4 Unk0660, p5 Unk0766) Unk0767 := …

  # Lower.trait_impl_block/4
  pub def trait_impl_block(protocols Vec(Map(Unk0010, Vec(Unk0009))), impl_decls Vec(Map(Unk0010, Vec(Unk0009))), c Map(Unk0672, Unk0671), base_ec Tuple(Unk0694, Unk0693)) String := …

  # Lower.trait_params/2
  pub def trait_params(param_str String, self_repr Unk0752) String := …

  # Lower.tuple_or_one/2
  pub def tuple_or_one(p0 Vec(Sum2), f Fn(Sum2, String)) String := …

  # Lower.tvar_name?/1
  pub def tvar_name?(t Unk0768) Bool := …

  # Lower.type_idents/1
  pub def type_idents(p0 Unk0769) Vec(Unk0770) := …

  # Lower.type_param_tvars/1
  pub def type_param_tvars(t Unk0771) Unk0772 := …

  # Lower.used_ids/1
  pub def used_ids(ast Vec(Unk0669)) Unk0642 := …

  # Lower.user_type?/2
  pub def user_type?(t Unk0773, ctx Map(Unk0672, Unk0671)) Bool := …

  # Lower.variant_info/2
  pub def variant_info(meta Map(Unk0731, Option(Unk0730)), name Unk0722) Option(Unk0730) := …

  # Lower.variant_lit/2
  pub def variant_lit(info Option(Unk0730), pairs Vec(Unk0774)) Tuple(Unk0196, String) := …

  # Lower.variant_pairs/3
  pub def variant_pairs(info Option(Unk0730), args Vec(Option(Unk0017)), meta Map(Unk0731, Option(Unk0730))) Vec(Unk0774) := …

  # Lower.widen_char_arith/2
  pub def widen_char_arith(p0 Option(Unk0017), cvars Unk0775) Tuple(Unk0196, String) := …

  # Lower.with_chain_rs/4
  pub def with_chain_rs(p0 Vec(Unk0776), body String, _else_rs String, _ec Tuple(Unk0662, Unk0663)) String := …

  # Lower.word_member?/2
  pub def word_member?(str Unk0777, name Unk0721) Bool := …

  # Lower.word_scan/4
  pub def word_scan(p0 Vec(Unk0778), _name Vec(Unk0713), _repl String, _prev Bool) String := …

  # Lower.wrap_char/2
  pub def wrap_char(p0 Tuple(Unk0196, String), _cvars Unk0775) Tuple(Unk0196, String) := …

  # Macro.binders_here/1
  pub def binders_here(p0 Vec(Unk0779)) Vec(Unk0780) := …

  # Macro.build_env/1
  pub def build_env(defs Unk0781) Map(Unk0242, Unk0243) := …

  # Macro.check_portable!/2
  pub def check_portable!(name Unk0782, tmpl Option(Unk0017)) Unk0783 := …

  # Macro.collect_binders/1
  pub def collect_binders(node Vec(Unk0779)) Vec(Unk0780) := …

  # Macro.do_expand/4
  pub def do_expand(_env Map(Unk0242, Unk0243), _ast Option(Unk0017), d Int53, _p Bool) Tuple(Unk0196, String) := …

  # Macro.expand/3
  pub def expand(env Map(Unk0242, Unk0243), ast Option(Unk0017), p2 Vec(Tuple(Unk0784, Bool))) Option(Unk0017) := …

  # Macro.freshen/2
  pub def freshen(tmpl Vec(Unk0779), params Unk0785) Tuple(Unk0196, Vec(Unk0786)) := …
  ...
  # Macro.rename/2
  pub def rename(p0 Vec(Unk0779), ren Map(Unk0787, Vec(Unk0786))) Tuple(Unk0196, Vec(Unk0786)) := …

  # Macro.substitute/2
  pub def substitute(p0 Tuple(Unk0196, Vec(Unk0786)), subst Map(Unk0788, Option(Unk0017))) Option(Unk0017) := …

  # Macro.walk_for_with/1
  pub def walk_for_with(p0 Option(Unk0017)) Tuple(Unk0196, String) := …

  # Opaque.do_erase/2
  pub def do_erase(prog Unk0789, ctx Tuple(Unk0791, Unk0790)) Map(Unk0033, Vec(Map(Unk0010, Vec(Unk0009)))) := …

  # Opaque.erase/1
  pub def erase(p0 Map(Unk0022, Vec(Map(Unk0010, Vec(Unk0009))))) Map(Unk0033, Vec(Map(Unk0010, Vec(Unk0009)))) := …

  # Opaque.erase_clause/3
  pub def erase_clause(p0 Unk0792, _ctx Unk0793, _env Unk0794) Clause := …

  # Opaque.erase_const/2
  pub def erase_const(p0 Unk0795, p1 Unk0796) Const := …

  # Opaque.erase_ctx/1
  pub def erase_ctx(all Vec(Unk0797)) Tuple(Unk0791, Unk0790) := …

  # Opaque.erase_func/2
  pub def erase_func(p0 Unk0798, p1 Tuple(Unk0791, Unk0790)) Func := …

  # Opaque.erase_mod/2
  pub def erase_mod(p0 Unk0799, ctx Tuple(Unk0791, Unk0790)) Mod := …

  # Opaque.erase_struct/2
  pub def erase_struct(p0 Unk0800, p1 Tuple(Unk0791, Unk0790)) Struct := …

  # Opaque.erase_type/2
  pub def erase_type(p0 Unk0801, p1 Tuple(Unk0791, Unk0790)) Type := …

  # Opaque.erase_variant/2
  pub def erase_variant(p0 Unk0802, names Unk0803) Variant := …

  # Opaque.opaques/1
  pub def opaques(prog Map(Unk0804, Vec(Unk0797))) Vec(Unk0797) := …

  # Opaque.strip/3
  pub def strip(p0 Vec(Unk0805), p1 Unk0806, env Map(Unk0086, Vec(Unk0079))) Vec(Unk0805) := …

  # Opaque.strip_into/3
  pub def strip_into(ast Vec(Unk0805), ctx Unk0806, env Map(Unk0086, Vec(Unk0079))) Vec(Unk0805) := …

  # Opaque.subst/2
  pub def subst(p0 Option(Unk0807), _names Unk0808) Option(Unk0807) := …

  # Opaque.subst_fix/4
  pub def subst_fix(type Option(Unk0807), _names Unk0808, _re Unk0809, p3 Int53) Option(Unk0807) := …
  ...
  pub def lower(pat Sum2, env Map(Unk0374, Unk0375)) Tuple(Unk0810, Bool) := …

  # PatternLower.lower_clause/2
  pub def lower_clause(p0 Unk0811, env Map(Unk0374, Unk0375)) Unk0373 := …

  # PatternLower.lower_list/3
  pub def lower_list(p0 Vec(Sum2), p1 Sum2, _env Map(Unk0374, Unk0375)) Tuple(Unk0810, Bool) := …

  # PatternLower.lower_many/2
  pub def lower_many(ps Vec(Sum2), env Map(Unk0374, Unk0375)) Unk0812 := …

  # PortAnalysis.analyze/1
  pub def analyze(sources Unk0813) Unk0814 := …

  # PortAnalysis.case_arm_sets/1
  pub def case_arm_sets(ast Unk0815) Vec(Unk0816) := …

  # PortAnalysis.clause_head_sets/1
  pub def clause_head_sets(ast Unk0815) Vec(Unk0816) := …

  # PortAnalysis.cluster_sums/1
  pub def cluster_sums(sets Vec(Unk0817)) Unk0533 := …

  # PortAnalysis.collect_errors/2
  pub def collect_errors(ast Unk0818, acc Unk0819) Unk0819 := …

  # PortAnalysis.collect_groups/1
  pub def collect_groups(p0 Unk0820) Vec(Unk0531) := …

  # PortAnalysis.collect_structs/2
  pub def collect_structs(ast Unk0821, acc Unk0822) Unk0822 := …

  # PortAnalysis.dispatch_sets/1
  pub def dispatch_sets(ast Unk0815) Vec(Unk0817) := …

  # PortAnalysis.error_proposal/1
  pub def error_proposal(p0 Unk0823) Unk0824 := …

  # PortAnalysis.error_shape/1
  pub def error_shape(p0 Unk0825) Tuple(Unk0827, Option(Unk0826)) := …

  # PortAnalysis.errors_section/1
  pub def errors_section(data Unk0828) String := …

  # PortAnalysis.head_name_pats/1
  pub def head_name_pats(p0 Unk0829) Tuple(Unk0830, Vec(Unk0831)) := …

  # PortAnalysis.holes_section/1
  pub def holes_section(data Unk0828) String := …

  # PortAnalysis.module_name/1
  pub def module_name(p0 Unk0832) String := …

  # PortAnalysis.module_report/3
  pub def module_report(file Unk0833, ast Unk0832, src Unk0834) Unk0835 := …

  # PortAnalysis.module_stmts/1
  pub def module_stmts(p0 Unk0836) Vec(String) := …

  # PortAnalysis.needs_review?/1
  pub def needs_review?(p0 Unk0837) Bool := …

  # PortAnalysis.param_name_index/1
  pub def param_name_index(mods_groups Vec(Tuple(String, Vec(Unk0531)))) Unk0838 := …

  # PortAnalysis.parse/1
  pub def parse(src Unk0839) Option(Unk0840) := …

  # PortAnalysis.pascal/1
  pub def pascal(atom_str Unk0841) Unk0842 := …

  # PortAnalysis.pattern_structs/1
  pub def pattern_structs(p0 Unk0843) Vec(Unk0844) := …

  # PortAnalysis.reach_note/1
  pub def reach_note(type String) Unk0845 := …

  # PortAnalysis.short/1
  pub def short(p0 Unk0846) String := …

  # PortAnalysis.sigs_section/1
  pub def sigs_section(data Unk0828) String := …

  # PortAnalysis.src_of/2
  pub def src_of(sources Unk0813, file Unk0847) Unk0834 := …

  # PortAnalysis.summary_section/1
  pub def summary_section(data Unk0828) String := …

  # PortAnalysis.sums_section/1
  pub def sums_section(data Unk0828) String := …

  # PortAnalysis.to_markdown/1
  pub def to_markdown(data Unk0828) Unk0848 := …

  # Pratt.after_paren/2
  pub def after_paren(tokens Vec(Unk0849), p1 Int53) Vec(Unk0849) := …

  # Pratt.assoc/1
  pub def assoc(op Option(Unk0850)) Unk0851 := …

  # Pratt.bp/1
  pub def bp(op Option(Unk0850)) Tuple(Int53, Int53) := …

  # Pratt.climb/3
  pub def climb(lhs Option(Unk0852), tokens Vec(Vec(Vec(Unk0616))), min_bp Int53) Tuple(Option(Unk0852), Vec(Vec(Vec(Unk0616)))) := …

  # Pratt.collect_dots/2
  pub def collect_dots(node Tuple(Unk0854, Unk0853), p1 Vec(Vec(Unk0616))) Tuple(Tuple(Unk0854, Unk0853), Vec(Vec(Unk0616))) := …

  # Pratt.desugar_prop/2
  pub def desugar_prop(stmts Vec(Tuple(Unk0855, Unk0856)), depth Int53) Tuple(Unk0857, Vec(Tuple(Unk0855, Unk0856))) := …

  # Pratt.desugar_propagation/1
  pub def desugar_propagation(stmts Vec(Tuple(Unk0855, Unk0856))) Tuple(Unk0857, Vec(Tuple(Unk0855, Unk0856))) := …

  # Pratt.expect_kw/2
  pub def expect_kw(p0 Vec(Vec(Vec(Unk0616))), k String) Vec(Vec(Vec(Unk0616))) := …

  # Pratt.expect_op/2
  pub def expect_op(p0 Vec(Vec(Vec(Unk0616))), o String) Vec(Vec(Vec(Unk0616))) := …

  # Pratt.expect_rbracket/1
  pub def expect_rbracket(p0 Vec(Vec(Vec(Unk0616)))) Vec(Vec(Vec(Unk0616))) := …

  # Pratt.expect_rparen/1
  pub def expect_rparen(p0 Vec(Vec(Vec(Unk0616)))) Vec(Vec(Vec(Unk0616))) := …

  # Pratt.finish_arg/2
  pub def finish_arg(a Unk0858, p1 Vec(Vec(Vec(Unk0616)))) Tuple(Vec(Unk0858), Vec(Vec(Vec(Vec(Unk0616))))) := …

  # Pratt.here/1
  pub def here(p0 Vec(Unk0859)) String := …

  # Pratt.int_of/1
  pub def int_of(n Unk0860) Vec(Tuple(Unk0861, Unk0862)) := …

  # Pratt.lambda_ahead?/1
  pub def lambda_ahead?(p0 Vec(Unk0849)) Bool := …

  # Pratt.level/1
  pub def level(op Option(Unk0850)) Unk0863 := …

  # Pratt.opinfo/1
  pub def opinfo(op Option(Unk0850)) Unk0864 := …

  # Pratt.parse/1
  pub def parse(ast String) Option(Unk0017) := …

  # Pratt.parse_args/1
  pub def parse_args(p0 Vec(Vec(Vec(Vec(Unk0616))))) Tuple(Vec(Unk0858), Vec(Vec(Vec(Vec(Unk0616))))) := …

  # Pratt.parse_arms/2
  pub def parse_arms(p0 Vec(Vec(Vec(Unk0616))), acc Vec(Unk0865)) Tuple(Vec(Unk0865), Vec(Vec(Vec(Unk0616)))) := …

  # Pratt.parse_block/1
  pub def parse_block(tokens Vec(Vec(Vec(Unk0616)))) Tuple(Tuple(Unk0857, Vec(Tuple(Unk0855, Unk0856))), Vec(Vec(Vec(Unk0616)))) := …

  # Pratt.parse_body/1
  pub def parse_body(ast Option(Unk0017)) Option(Unk0017) := …

  # Pratt.parse_capture/1
  pub def parse_capture(p0 Vec(Vec(Vec(Unk0616)))) Tuple(Tuple(Unk0866, Vec(Tuple(Unk0861, Unk0862))), Vec(Vec(Vec(Unk0616)))) := …

  # Pratt.parse_case/1
  pub def parse_case(tokens Vec(Vec(Vec(Unk0616)))) Tuple(Tuple(Unk0866, Vec(Tuple(Unk0861, Unk0862))), Vec(Vec(Vec(Unk0616)))) := …

  # Pratt.parse_expr/2
  pub def parse_expr(tokens Vec(Vec(Vec(Unk0616))), min_bp Int53) Tuple(Option(Unk0852), Vec(Vec(Vec(Unk0616)))) := …

  # Pratt.parse_if/1
  pub def parse_if(tokens Vec(Vec(Vec(Unk0616)))) Tuple(Tuple(Unk0866, Vec(Tuple(Unk0861, Unk0862))), Vec(Vec(Vec(Unk0616)))) := …

  # Pratt.parse_lambda/1
  pub def parse_lambda(p0 Vec(Vec(Vec(Unk0616)))) Tuple(Tuple(Unk0866, Vec(Tuple(Unk0861, Unk0862))), Vec(Vec(Vec(Unk0616)))) := …

  # Pratt.parse_list/2
  pub def parse_list(p0 Vec(Vec(Vec(Unk0616))), acc Vec(Unk0867)) Tuple(Tuple(Unk0866, Vec(Tuple(Unk0861, Unk0862))), Vec(Vec(Vec(Unk0616)))) := …

  # Pratt.parse_map/2
  pub def parse_map(p0 Vec(Vec(Vec(Vec(Unk0616)))), acc Vec(Tuple(Unk0861, Unk0862))) Tuple(Tuple(Unk0866, Vec(Tuple(Unk0861, Unk0862))), Vec(Vec(Vec(Vec(Unk0616))))) := …

  # Pratt.parse_param/1
  pub def parse_param(p0 Vec(Vec(Vec(Unk0616)))) Tuple(Tuple(Unk0869, Option(Unk0868)), Vec(Vec(Unk0616))) := …

  # Pratt.parse_params/1
  pub def parse_params(p0 Vec(Vec(Vec(Unk0616)))) Tuple(Vec(Unk0870), Vec(Vec(Vec(Unk0616)))) := …

  # Pratt.parse_pat/1
  pub def parse_pat(p0 Vec(Vec(Vec(Unk0616)))) Tuple(Tuple(Unk0871, Vec(Tuple(Unk0861, Unk0862))), Vec(Vec(Vec(Unk0616)))) := …

  # Pratt.parse_pat_args/2
  pub def parse_pat_args(p0 Vec(Vec(Vec(Unk0616))), acc Vec(Unk0872)) Tuple(Vec(Unk0872), Vec(Vec(Vec(Unk0616)))) := …

  # Pratt.parse_pat_fields/2
  pub def parse_pat_fields(p0 Vec(Vec(Vec(Vec(Unk0616)))), acc Vec(Tuple(Unk0873, Unk0874))) Tuple(Vec(Tuple(Unk0873, Unk0874)), Vec(Vec(Vec(Vec(Unk0616))))) := …

  # Pratt.parse_pat_list/2
  pub def parse_pat_list(p0 Vec(Vec(Vec(Unk0616))), acc Vec(Unk0875)) Tuple(Tuple(Unk0871, Vec(Tuple(Unk0861, Unk0862))), Vec(Vec(Vec(Unk0616)))) := …

  # Pratt.parse_pat_map/2
  pub def parse_pat_map(p0 Vec(Vec(Vec(Vec(Unk0616)))), acc Vec(Tuple(Unk0861, Unk0862))) Tuple(Tuple(Unk0871, Vec(Tuple(Unk0861, Unk0862))), Vec(Vec(Vec(Vec(Unk0616))))) := …

  # Pratt.parse_pat_tuple/2
  pub def parse_pat_tuple(p0 Vec(Vec(Vec(Unk0616))), acc Vec(Tuple(Unk0861, Unk0862))) Tuple(Tuple(Unk0871, Vec(Tuple(Unk0861, Unk0862))), Vec(Vec(Vec(Unk0616)))) := …

  # Pratt.parse_path/1
  pub def parse_path(p0 Vec(Vec(Vec(Unk0616)))) Tuple(Tuple(Unk0854, Unk0853), Vec(Vec(Unk0616))) := …

  # Pratt.parse_pats/1
  pub def parse_pats(str String) Vec(Unk0876) := …

  # Pratt.parse_pats/2
  pub def parse_pats(tokens Vec(Vec(Vec(Unk0616))), acc Vec(Unk0876)) Vec(Unk0876) := …

  # Pratt.parse_postfix/2
  pub def parse_postfix(node Tuple(Unk0866, Vec(Tuple(Unk0861, Unk0862))), p1 Vec(Vec(Vec(Unk0616)))) Tuple(Tuple(Unk0866, Vec(Tuple(Unk0861, Unk0862))), Vec(Vec(Vec(Unk0616)))) := …

  # Pratt.parse_prefix/1
  pub def parse_prefix(p0 Vec(Vec(Vec(Unk0616)))) Tuple(Tuple(Unk0866, Vec(Tuple(Unk0861, Unk0862))), Vec(Vec(Vec(Unk0616)))) := …

  # Pratt.parse_primary/1
  pub def parse_primary(p0 Vec(Vec(Vec(Unk0616)))) Tuple(Tuple(Unk0866, Vec(Tuple(Unk0861, Unk0862))), Vec(Vec(Vec(Unk0616)))) := …

  # Pratt.parse_stmt/1
  pub def parse_stmt(p0 Vec(Vec(Vec(Vec(Unk0616))))) Tuple(Tuple(Unk0878, Unk0877), Vec(Vec(Vec(Unk0616)))) := …

  # Pratt.parse_stmts/2
  pub def parse_stmts(p0 Vec(Vec(Vec(Vec(Unk0616)))), acc Vec(Unk0879)) Tuple(Vec(Unk0879), Vec(Vec(Vec(Vec(Unk0616))))) := …

  # Pratt.parse_tuple/2
  pub def parse_tuple(p0 Vec(Vec(Vec(Unk0616))), acc Vec(Tuple(Unk0861, Unk0862))) Tuple(Tuple(Unk0866, Vec(Tuple(Unk0861, Unk0862))), Vec(Vec(Vec(Unk0616)))) := …

  # Pratt.parse_type/1
  pub def parse_type(p0 Vec(Vec(Vec(Unk0616)))) Tuple(String, Vec(Vec(Unk0616))) := …

  # Pratt.parse_type_args/2
  pub def parse_type_args(tokens Vec(Vec(Vec(Unk0616))), acc Vec(Unk0880)) Tuple(Vec(Unk0880), Vec(Vec(Vec(Unk0616)))) := …

  # Pratt.parse_with/1
  pub def parse_with(tokens Vec(Vec(Vec(Unk0616)))) Tuple(Tuple(Unk0866, Vec(Tuple(Unk0861, Unk0862))), Vec(Vec(Vec(Unk0616)))) := …

  # Pratt.parse_with_clauses/2
  pub def parse_with_clauses(tokens Vec(Vec(Vec(Unk0616))), acc Vec(Tuple(Unk0882, Unk0881))) Tuple(Vec(Tuple(Unk0882, Unk0881)), Vec(Vec(Vec(Unk0616)))) := …

  # Pratt.pascal?/1
  pub def pascal?(s Unk0883) Bool := …

  # Pratt.peek_infix/1
  pub def peek_infix(p0 Vec(Vec(Vec(Unk0616)))) Option(Unk0850) := …

  # Pratt.same_level_root?/2
  pub def same_level_root?(p0 Option(Unk0852), op Option(Unk0850)) Bool := …

  # Pratt.sexpr/1
  pub def sexpr(p0 Option(Unk0017)) String := …

  # Pratt.sexpr_pat/1
  pub def sexpr_pat(p0 Unk0884) String := …

  # Pratt.sexpr_stmt/1
  pub def sexpr_stmt(p0 Unk0885) String := …

  # Pratt.str_interp/1
  pub def str_interp(parts Vec(Unk0886)) Tuple(Unk0866, Vec(Tuple(Unk0861, Unk0862))) := …

  # Pratt.tok_desc/1
  pub def tok_desc(p0 Unk0859) String := …
  ...
  pub def check_assoc!(protocols Vec(Unk0219), impl_decls Vec(Unk0219)) Unk0887 := …

  # Protocol.check_impl/3
  pub def check_impl(p0 Unk0888, protocols Unk0889, reg Unk0890) Unk0891 := …

  # Protocol.check_no_overlap/3
  pub def check_no_overlap(impls Vec(Unk0892), reg Unk0890, targets Unk0893) Unk0894 := …

  # Protocol.dispatcher/4
  pub def dispatcher(proto Unk0895, sig Unk0896, impls Vec(Unk0892), reg Unk0890) Vec(Unk0897) := …

  # Protocol.dispatcher_params/2
  pub def dispatcher_params(sig_params Unk0898, vars Vec(String)) Unk0899 := …

  # Protocol.expand/5
  pub def expand(protocols Unk0889, impls Vec(Unk0892), p2 Unk0319, p3 Unk0320, p4 Unk0321) Vec(Unk0322) := …

  # Protocol.guard_for!/3
  pub def guard_for!(type String, proto Unk0895, reg Unk0890) Unk0900 := …

  # Protocol.impl_methods/2
  pub def impl_methods(p0 Unk0892, protocols Unk0889) Vec(Unk0322) := …

  # Protocol.mangle/3
  pub def mangle(proto Unk0901, type Unk0902, method Unk0903) String := …

  # Protocol.param_type/1
  pub def param_type(p Unk0904) Unk0905 := …

  # Protocol.registry/2
  pub def registry(types Unk0906, structs Vec(Unk0907)) Unk0890 := …

  # Protocol.runtime_dispatch_target?/1
  pub def runtime_dispatch_target?(p0 Unk0893) Bool := …

  # Protocol.subst_self/2
  pub def subst_self(p0 Unk0908, _type Unk0909) Option(Unk0910) := …

  # Protocol.sum_guard/1
  pub def sum_guard(variants Unk0911) String := …

  # Protocol.tag_disjunction/2
  pub def tag_disjunction(variants Vec(Unk0912), lhs Unk0913) String := …

  # Range.check/3
  pub def check(lo Unk0914, hi Unk0915, a Sum1) Sum1 := …

  # Range.expand_of/2
  pub def expand_of(node Option(Unk0017), table Map(Unk0018, Unk0019)) Sum1 := …

  # Range.lit/1
  pub def lit(n Unk0916) Sum1 := …
  ...
  pub def all_emittable?(f Map(Unk0917, Vec(Unk0918)), pctx Unk0919) Bool := …

  # Reach.all_funcs/1
  pub def all_funcs(prog Map(Unk0022, Vec(Map(Unk0010, Vec(Unk0009))))) Vec(Map(Unk0010, Vec(Unk0009))) := …

  # Reach.analyze/1
  pub def analyze(prog Map(Unk0022, Vec(Map(Unk0010, Vec(Unk0009))))) Unk0920 := …

  # Reach.atom_prim_blocker/0
  pub def atom_prim_blocker() Unk0921 := …

  # Reach.bare_atom_blocker/0
  pub def bare_atom_blocker() Unk0921 := …

  # Reach.build_default/0
  pub def build_default() Option(Unk0922) := …

  # Reach.builder_tail_ok?/2
  pub def builder_tail_ok?(f Map(Unk0917, Vec(Unk0918)), generics Unk0923) Bool := …

  # Reach.check_contracts/2
  pub def check_contracts(prog Map(Unk0022, Vec(Map(Unk0010, Vec(Unk0009)))), p1 Option(Unk0922)) Tuple(Unk0924, String) := …

  # Reach.classify/3
  pub def classify(p0 Sum1, _modnames Unk0925, p2 Tuple(Vec(Unk0921), Unk0926)) Tuple(Vec(Unk0921), Unk0926) := …

  # Reach.collect_ctors/2
  pub def collect_ctors(p0 Sum1, ctors Map(Unk0927, Unk0928)) Vec(Tuple(Unk0929, Unk0930)) := …

  # Reach.conc_erl?/2
  pub def conc_erl?(m String, fun Unk0931) Bool := …

  # Reach.contract_message/1
  pub def contract_message(violations Vec(Unk0932)) String := …

  # Reach.core/2
  pub def core(src Unk0933, parser Fn(Unk0934, Unk0935)) Sum1 := …

  # Reach.ctor_aligned?/2
  pub def ctor_aligned?(p0 Tuple(Unk0929, Unk0930), f Map(Unk0917, Vec(Unk0918))) Bool := …

  # Reach.deep/1
  pub def deep(t Vec(Unk0936)) Vec(Unk0937) := …

  # Reach.emittable_parametric?/1
  pub def emittable_parametric?(t Unk0938) Unk0939 := …

  # Reach.ffi/2
  pub def ffi(construct String, conc? Bool) Unk0921 := …

  # Reach.find_atom_ordering/1
  pub def find_atom_ordering(p0 Vec(Unk0936)) Vec(Unk0937) := …

  # Reach.fixpoint/2
  pub def fixpoint(facts Unk0940, table Map(Unk0941, Unk0942)) Map(Unk0941, Unk0942) := …

  # Reach.fn_type_blocker/0
  pub def fn_type_blocker() Unk0921 := …

  # Reach.func_symbol_violations/1
  pub def func_symbol_violations(f Unk0943) Vec(Unk0937) := …

  # Reach.gate!/1
  pub def gate!(prog Map(Unk0022, Vec(Map(Unk0010, Vec(Unk0009))))) Symbol := …

  # Reach.gate!/2
  pub def gate!(prog Map(Unk0022, Vec(Map(Unk0010, Vec(Unk0009)))), default Option(Unk0922)) Symbol := …

  # Reach.int_blocker/0
  pub def int_blocker() Unk0921 := …

  # Reach.js_wide_int?/1
  pub def js_wide_int?(t Unk0944) Bool := …

  # Reach.mix_default/0
  pub def mix_default() Unk0945 := …

  # Reach.parametric_blocker/0
  pub def parametric_blocker() Unk0921 := …

  # Reach.parametric_constructions/2
  pub def parametric_constructions(f Map(Unk0917, Vec(Unk0918)), ctors Map(Unk0927, Unk0928)) Vec(Tuple(Unk0929, Unk0930)) := …

  # Reach.parametric_ctx/2
  pub def parametric_ctx(prog Map(Unk0022, Vec(Map(Unk0010, Vec(Unk0009)))), funs Vec(Map(Unk0010, Vec(Unk0009)))) Unk0919 := …

  # Reach.parametric_rs_ok?/2
  pub def parametric_rs_ok?(f Map(Unk0917, Vec(Unk0918)), pctx Unk0919) Bool := …

  # Reach.parametric_type?/1
  pub def parametric_type?(t Unk0946) Bool := …

  # Reach.pascal?/1
  pub def pascal?(s Unk0947) Bool := …

  # Reach.ref_blocker/0
  pub def ref_blocker() Unk0921 := …

  # Reach.result_value_blocker/0
  pub def result_value_blocker() Unk0921 := …

  # Reach.scan/3
  pub def scan(p0 Sum1, modnames Unk0925, p2 Tuple(Vec(Unk0921), Unk0926)) Tuple(Vec(Unk0921), Unk0926) := …

  # Reach.scan_func/3
  pub def scan_func(f Map(Unk0917, Vec(Unk0918)), modnames Unk0925, pctx Unk0919) Tuple(Vec(Unk0921), Unk0926) := …

  # Reach.sig_idents/1
  pub def sig_idents(f Map(Unk0949, Vec(Unk0948))) Unk0950 := …

  # Reach.sig_uses_fn_type?/1
  pub def sig_uses_fn_type?(f Map(Unk0917, Vec(Unk0918))) Bool := …

  # Reach.symbol_lint!/1
  pub def symbol_lint!(prog Map(Unk0022, Vec(Map(Unk0010, Vec(Unk0009))))) Symbol := …

  # Reach.tail_calls_generic?/2
  pub def tail_calls_generic?(p0 Unk0951, generics Unk0923) Bool := …

  # Reach.tvar?/1
  pub def tvar?(t Unk0952) Unk0953 := …

  # Reach.type_has_tvar?/1
  pub def type_has_tvar?(t Unk0954) Bool := …

  # Reach.type_idents/1
  pub def type_idents(t Unk0954) Vec(Unk0955) := …

  # Reach.uses_parametric?/2
  pub def uses_parametric?(f Map(Unk0917, Vec(Unk0918)), names Unk0956) Bool := …

  # Reach.validate_default/1
  pub def validate_default(p0 Option(Unk0922)) Option(Unk0922) := …

  # Reach.wide_prim_blocker/0
  pub def wide_prim_blocker() Unk0921 := …

  # Reach.width_blocker/0
  pub def width_blocker() Unk0921 := …

  # Repl.accumulate_line/2
  pub def accumulate_line(line String, p1 Unk0957) Tuple(Vec(String), String) := …

  # Repl.bind_env/2
  pub def bind_env(binds Vec(Unk0958), ic Map(Unk0081, Map(Vec(Unk0079), Vec(Unk0079)))) Map(Unk0086, Option(Unk0959)) := …

  # Repl.bind_with_type/4
  pub def bind_with_type(s Session, input String, name String, type Option(Unk0959)) Tuple(Tuple(Unk0960, String), Session) := …

  # Repl.candidate_pool/2
  pub def candidate_pool(p0 Unk0961, _s Session) Vec(Unk0962) := …

  # Repl.common_prefix/2
  pub def common_prefix(a Unk0963, b Unk0964) String := …

  # Repl.common_prefix/3
  pub def common_prefix(p0 Unk0963, p1 Unk0964, acc String) String := …

  # Repl.complete/2
  pub def complete(before_cursor String, p1 Unk0965) Tuple(Vec(Unk0966), String) := …

  # Repl.continuation/2
  pub def continuation(_word String, p1 Vec(Unk0966)) String := …

  # Repl.decl_names/1
  pub def decl_names(input String) Unk0967 := …

  # Repl.describe/1
  pub def describe(p0 Unk0968) Unk0969 := …

  # Repl.eval/2
  pub def eval(p0 Unk0970, input String) Unk0971 := …

  # Repl.eval_bind/4
  pub def eval_bind(s Session, input String, name String, rhs Option(Unk0017)) Tuple(Tuple(Unk0960, String), Session) := …

  # Repl.eval_decl/2
  pub def eval_decl(s Tuple(Unk0972, Vec(Tuple(Unk0967, Unk0973))), input String) Tuple(Tuple(Unk0974, Unk0967), Unk0975) := …

  # Repl.eval_expr/2
  pub def eval_expr(s Session, input String) Tuple(Tuple(Unk0960, String), Session) := …

  # Repl.eval_stmt/2
  pub def eval_stmt(s Session, input String) Tuple(Tuple(Unk0960, String), Session) := …

  # Repl.flush_entries/1
  pub def flush_entries(p0 Unk0976) Vec(Unk0977) := …

  # Repl.infer_or_unknown/3
  pub def infer_or_unknown(ast Option(Unk0017), env Map(Unk0086, Option(Unk0959)), ic Map(Unk0081, Map(Vec(Unk0079), Vec(Unk0079)))) Option(Unk0959) := …
  ...
  # Repl.program/3
  pub def program(units Vec(Tuple(Unk0967, Unk0973)), binds Vec(Tuple(String, Unk0980)), expr_src String) String := …

  # Repl.reload/2
  pub def reload(s Tuple(Unk0972, Vec(Tuple(Unk0967, Unk0973))), src String) Symbol := …

  # Repl.render/1
  pub def render(p0 Unk0981) String := …

  # Repl.run/4
  pub def run(s Session, binds Vec(Tuple(String, Unk0980)), units Vec(Tuple(Unk0967, Unk0973)), expr_src String) Tuple(Unk0982, Unk0983) := …

  # Repl.safe_decl/1
  pub def safe_decl(units Vec(Tuple(Unk0967, Unk0973))) Map(Unk0022, Vec(Map(Unk0010, Vec(Unk0009)))) := …

  # Repl.safe_infer/3
  pub def safe_infer(ast Option(Unk0017), env Map(Unk0086, Option(Unk0959)), ic Map(Unk0081, Map(Vec(Unk0079), Vec(Unk0079)))) Option(Unk0959) := …

  # Repl.safe_infer_input/3
  pub def safe_infer_input(input String, env Map(Unk0086, Option(Unk0959)), ic Map(Unk0081, Map(Vec(Unk0079), Vec(Unk0079)))) Option(Unk0959) := …
  ...
  # Repl.type_of/2
  pub def type_of(p0 Unk0987, input String) Option(Unk0959) := …

  # Repl.units_src/1
  pub def units_src(units Vec(Tuple(Unk0967, Unk0973))) String := …

  # SelfHost.badge/1
  pub def badge(p0 Unk0988) String := …

  # SelfHost.composition/0
  pub def composition() Unk0989 := …

  # SelfHost.count/1
  pub def count(status Unk0990) Int53 := …

  # SelfHost.evidence/1
  pub def evidence(p0 Unk0991) String := …

  # SelfHost.external_host_calls/1
  pub def external_host_calls(prog Map(Unk0992, Vec(Map(Unk0994, Vec(Unk0993))))) Vec(Unk0995) := …
  ...
  pub def sibling_compose_call?(construct Unk0998, siblings Unk0999) Bool := …

  # SelfHost.stages/0
  pub def stages() Unk1000 := …

  # SelfHost.status_markdown/1
  pub def status_markdown(stages Vec(Unk1001)) String := …

  # Shadow.ded_bind/5
  pub def ded_bind(n Unk1002, t Bool, e Vec(Unk1003), p3 Unk1004, fresh Fn(Unk1006, Unk1005, Unk1007)) Unk1008 := …

  # Shadow.ded_block/4
  pub def ded_block(stmts Vec(Unk1009), r Map(Unk1011, Unk1010), ver Unk1012, fresh Fn(Unk1006, Unk1005, Unk1007)) Vec(Unk0545) := …

  # Shadow.ded_expr/3
  pub def ded_expr(p0 Vec(Unk1003), r Map(Unk1011, Unk1010), _fresh Fn(Unk1006, Unk1005, Unk1007)) Vec(Unk1003) := …

  # Shadow.dedup/3
  pub def dedup(stmts Vec(Unk1009), params Vec(Unk0548), fresh Fn(Unk1006, Unk1005, Unk1007)) Vec(Unk0545) := …

  # Shadow.pat_var_names/1
  pub def pat_var_names(p0 Sum2) Vec(Unk1013) := …

  # ShowStdlib.module/0
  pub def module() Unk0262 := …

  # Test.run/2
  pub def run(src String, p1 Unk1014) Unk1015 := …

  # Tour.build_cell/1
  pub def build_cell(p0 Unk1016) Unk1017 := …

  # Tour.build_reach_example/1
  pub def build_reach_example(p0 Unk1018) Unk1019 := …

  # Tour.elixir_module/1
  pub def elixir_module(src String) Unk1020 := …

  # Tour.encode/2
  pub def encode(map Vec(Unk1021), indent Int53) String := …

  # Tour.encode_string/1
  pub def encode_string(s Vec(Unk1021)) String := …

  # Tour.generate/0
  pub def generate() Unk1022 := …

  # Tour.reach_map/1
  pub def reach_map(prog Map(Unk0022, Vec(Map(Unk0010, Vec(Unk0009))))) Unk1023 := …

  # Transpile.add_clause/2
  pub def add_clause(open Tuple(Unk1024, Vec(Unk1025)), clause Unk1025) Option(Unk1026) := …

  # Transpile.build_clause/2
  pub def build_clause(head Unk1027, kw Unk1028) Unk1025 := …

  # Transpile.case_arm/1
  pub def case_arm(p0 Unk1029) String := …

  # Transpile.classify/1
  pub def classify(p0 String) Tuple(Unk1030, String) := …

  # Transpile.close_group/2
  pub def close_group(acc Vec(Unk1031), p1 Unk1031) Vec(Unk1031) := …

  # Transpile.def_groups/1
  pub def def_groups(stmts Vec(String)) Vec(Unk1031) := …

  # Transpile.escape/1
  pub def escape(s Unk1032) Unk1033 := …

  # Transpile.escape_lit/1
  pub def escape_lit(s Unk1034) String := …

  # Transpile.flush/2
  pub def flush(p0 Unk1035, _sigmap Map(Tuple(Unk1036, Unk1037), Bool)) Vec(String) := …

  # Transpile.hole_sig?/1
  pub def hole_sig?(p0 Unk1038) Bool := …

  # Transpile.infer_program/1
  pub def infer_program(ast Unk1039) Tuple(Unk1040, Vec(String)) := …

  # Transpile.infer_report/1
  pub def infer_report(source Unk1041) Unk1042 := …

  # Transpile.infer_sigs/1
  pub def infer_sigs(p0 Unk1039) Unk1040 := …

  # Transpile.inferred/1
  pub def inferred(source Unk0834) Tuple(Unk1040, Vec(String)) := …

  # Transpile.max_placeholder/1
  pub def max_placeholder(p0 Vec(Unk1043)) Int53 := …

  # Transpile.mod_str/1
  pub def mod_str(p0 Unk1044) String := …

  # Transpile.module_groups/1
  pub def module_groups(src Unk1045) Tuple(String, Unk1046) := …

  # Transpile.moduledoc_lines/1
  pub def moduledoc_lines(text Unk1047) Vec(String) := …

  # Transpile.name_str/1
  pub def name_str(n Unk1048) Unk1049 := …

  # Transpile.new_group/3
  pub def new_group(vis Unk1050, clause Unk1025, doc Option(Unk1051)) Option(Unk1026) := …

  # Transpile.one_line/1
  pub def one_line(s Unk1052) Unk1053 := …

  # Transpile.prime_xmod/1
  pub def prime_xmod(sources Unk1054) Unk1055 := …

  # Transpile.rank/1
  pub def rank(entries Unk1056) Unk1057 := …

  # Transpile.render_body/1
  pub def render_body(p0 Bool) Option(Unk1058) := …

  # Transpile.render_clause/2
  pub def render_clause(kw String, c Unk1059) String := …

  # Transpile.render_items/3
  pub def render_items(stmts Vec(String), sigmap Map(Tuple(Unk1036, Unk1037), Bool), mod_name Unk1060) Vec(String) := …

  # Transpile.same_group?/3
  pub def same_group?(open Unk1061, vis Unk1062, clause Unk1025) Bool := …

  # Transpile.short_name/1
  pub def short_name(p0 Unk1044) String := …

  # Transpile.sibling_module?/2
  pub def sibling_module?(p0 Unk1063, m String) Bool := …

  # Transpile.simple?/1
  pub def simple?(p0 Vec(Unk1064)) Bool := …

  # Transpile.snippet/1
  pub def snippet(node Unk1044) String := …

  # Transpile.stdlib_map/0
  pub def stdlib_map() Unk0532 := …

  # Transpile.string_part/1
  pub def string_part(s Unk1034) Tuple(Unk1065, String) := …

  # Transpile.string_parts/1
  pub def string_parts(segments Unk1066) Unk1067 := …

  # Transpile.struct_decl/2
  pub def struct_decl(mod_name Unk1060, fields Vec(Unk1068)) String := …

  # Transpile.struct_field?/1
  pub def struct_field?(a Unk1069) Bool := …
  ...
  pub def var_name(p0 Unk1044) String := …
```
...
| `Unk0203` | 3 | `Core.first_unsupported/2:p1`, `Core.first_unsupported/2:ret`, `Core.reject_unsupported!/4:p1` |
| `Unk0204` | 2 | `Core.first_unsupported/2:p1`, `Core.reject_unsupported!/4:p1` |
...
| `Unk0456` | 59 | `Infer.app1/2:p1`, `Infer.app1/2:ret`, `Infer.apply_spec_terms/4:p3`, `Infer.apply_spec_terms/4:ret`, `Infer.bind/3:p0`, `Infer.bind/3:p1`, `Infer.bind_checked/3:p0`, `Infer.bind_checked/3:p1`, `Infer.bind_checked/3:ret`, `Infer.bind_params/3:p2`, `Infer.call_sig/6:p5`, `Infer.call_sig/6:ret`, `Infer.do_unify/3:p0`, `Infer.do_unify/3:ret`, `Infer.free_vars/2:p0`, `Infer.fresh/1:p0`, `Infer.fresh/1:ret`, `Infer.fresh_n/2:p0`, `Infer.fresh_n/2:ret`, `Infer.fresh_num/1:p0`, `Infer.fresh_num/1:ret`, `Infer.freshen_tvars/2:p1`, `Infer.freshen_tvars/2:ret`, `Infer.gen/4:p3`, `Infer.gen/4:ret`, `Infer.gen_args_then_fresh/4:p3`, `Infer.gen_args_then_fresh/4:ret`, `Infer.gen_block/4:p3`, `Infer.gen_block/4:ret`, `Infer.gen_cons/5:p4`, `Infer.gen_cons/5:ret`, `Infer.gen_pat/4:p3`, `Infer.gen_pat/4:ret`, `Infer.gen_pat_cons/5:p4`, `Infer.gen_pat_cons/5:ret`, `Infer.generalize_map/3:p2`, `Infer.instantiate/5:p4`, `Infer.instantiate/5:ret`, `Infer.mark_num/2:p0`, `Infer.mark_num/2:ret`, `Infer.maybe_tuple/4:p3`, `Infer.maybe_tuple/4:ret`, `Infer.num_conflict?/3:p0`, `Infer.num_conflict?/3:p1`, `Infer.occurs?/3:p0`, `Infer.occurs?/3:p1`, `Infer.render/3:p0`, `Infer.render_wp/3:p0`, `Infer.resolve/2:p0`, `Infer.resolve_program/2:p1`, `Infer.resolve_struct_params/4:p3`, `Infer.resolve_struct_params/4:ret`, `Infer.seed_spec/6:p5`, `Infer.seed_spec/6:ret`, `Infer.sigvar_call/5:p4`, `Infer.store_new/0:ret`, `Infer.unify/3:p0`, `Infer.unify/3:ret`, `Infer.unk_vars/2:p0` |
| `Unk0457` | 17 | `Infer.apply_spec_terms/4:p0`, `Infer.call_sig/6:p0`, `Infer.call_sig/6:p4`, `Infer.cluster_name/2:p0`, `Infer.collect_specs/1:ret`, `Infer.gen/4:p2`, `Infer.gen_args_then_fresh/4:p2`, `Infer.gen_block/4:p2`, `Infer.gen_cons/5:p3`, `Infer.infer_group/2:p1`, `Infer.instantiate/5:p3`, `Infer.maybe_tuple/4:p2`, `Infer.ok_payload/3:p1`, `Infer.resolve_struct_params/4:p2`, `Infer.result_analysis/3:p1`, `Infer.seed_spec/6:p0`, `Infer.sigvar_call/5:p0` |
| `Unk0458` | 2 | `Infer.apply_spec_terms/4:p1`, `Infer.seed_spec/6:p3` |
| `Unk0459` | 1 | `Infer.bind/3:ret` |
| `Unk0460` | 3 | `Infer.bind_checked/3:ret`, `Infer.do_unify/3:ret`, `Infer.unify/3:ret` |
| `Unk0461` | 1 | `Infer.bind_params/3:p0` |
| `Unk0462` | 1 | `Infer.bind_params/3:p1` |
| `Unk0463` | 1 | `Infer.bind_params/3:ret` |
| `Unk0464` | 1 | `Infer.build_ctx/2:p0` |
| `Unk0465` | 1 | `Infer.build_ctx/2:p1` |
| `Unk0466` | 1 | `Infer.build_ctx/2:ret` |
| `Unk0467` | 1 | `Infer.build_ledger/2:p0` |
| `Unk0468` | 1 | `Infer.build_ledger/2:ret` |
| `Unk0469` | 17 | `Infer.call_sig/6:p0`, `Infer.call_sig/6:p4`, `Infer.cluster_name/2:p0`, `Infer.collect_specs/1:ret`, `Infer.gen/4:p2`, `Infer.gen_args_then_fresh/4:p2`, `Infer.gen_block/4:p2`, `Infer.gen_cons/5:p3`, `Infer.infer_group/2:p1`, `Infer.instantiate/5:p3`, `Infer.maybe_tuple/4:p2`, `Infer.ok_payload/3:p1`, `Infer.resolve_struct_params/4:p2`, `Infer.result_analysis/3:p1`, `Infer.seed_spec/6:p0`, `Infer.seed_spec/6:p1`, `Infer.sigvar_call/5:p0` |
| `Unk0470` | 14 | `Infer.call_sig/6:p0`, `Infer.call_sig/6:p4`, `Infer.gen/4:p2`, `Infer.gen_args_then_fresh/4:p2`, `Infer.gen_block/4:p2`, `Infer.gen_cons/5:p3`, `Infer.infer_group/2:p1`, `Infer.instantiate/5:p3`, `Infer.maybe_tuple/4:p2`, `Infer.ok_payload/3:p1`, `Infer.resolve_struct_params/4:p2`, `Infer.result_analysis/3:p1`, `Infer.seed_spec/6:p0`, `Infer.sigvar_call/5:p0` |
| `Unk0471` | 1 | `Infer.call_sig/6:p1` |
| `Unk0472` | 1 | `Infer.case_arm/1:p0` |
| `Unk0473` | 1 | `Infer.case_arm/1:ret` |
| `Unk0474` | 1 | `Infer.case_arm/1:ret` |
| `Unk0475` | 1 | `Infer.clear_xmod/0:ret` |
...
| `Unk0497` | 2 | `Infer.parse_type/2:p1`, `Infer.tvar?/1:p0` |
| `Unk0498` | 1 | `Infer.parse_type/2:p1` |
| `Unk0499` | 1 | `Infer.prime_xmod/2:p0` |
| `Unk0500` | 1 | `Infer.prime_xmod/2:p1` |
| `Unk0501` | 1 | `Infer.prime_xmod/2:ret` |
| `Unk0502` | 1 | `Infer.put_slot/3:p0` |
| `Unk0503` | 1 | `Infer.put_slot/3:ret` |
| `Unk0504` | 1 | `Infer.render_wp/3:p1` |
| `Unk0505` | 1 | `Infer.resolve_program/2:p0` |
| `Unk0506` | 2 | `Infer.resolve_program/2:ret`, `Infer.whole_program/4:ret` |
| `Unk0507` | 1 | `Infer.resolve_struct_params/4:p0` |
| `Unk0508` | 1 | `Infer.resolve_struct_params/4:p1` |
| `Unk0509` | 1 | `Infer.result_analysis/3:p0` |
| `Unk0510` | 1 | `Infer.result_analysis/3:ret` |
| `Unk0511` | 1 | `Infer.result_tag/1:p0` |
| `Unk0512` | 1 | `Infer.result_tag/1:ret` |
| `Unk0513` | 1 | `Infer.result_tag/1:ret` |
| `Unk0514` | 1 | `Infer.sig_of/1:p0` |
| `Unk0515` | 1 | `Infer.sig_of/1:ret` |
| `Unk0516` | 1 | `Infer.sigvar_call/5:p1` |
| `Unk0517` | 1 | `Infer.sigvar_call/5:p2` |
| `Unk0518` | 1 | `Infer.sigvar_call/5:ret` |
| `Unk0519` | 1 | `Infer.slot_sig/3:p2` |
| `Unk0520` | 1 | `Infer.slot_sig/3:ret` |
| `Unk0521` | 1 | `Infer.spec_pair/1:p0` |
| `Unk0522` | 1 | `Infer.spec_pair/1:ret` |
| `Unk0523` | 1 | `Infer.spec_pair/1:ret` |
| `Unk0524` | 1 | `Infer.spec_pair/1:ret` |
| `Unk0525` | 1 | `Infer.spec_str/1:p0` |
| `Unk0526` | 4 | `Infer.translate_spec/1:p0`, `Infer.union_spec/2:p0`, `Infer.union_spec/2:p1`, `Infer.vec_spec/1:p0` |
| `Unk0527` | 1 | `Infer.tvar?/1:ret` |
| `Unk0528` | 1 | `Infer.tvar_name/1:p0` |
| `Unk0529` | 1 | `Infer.tvar_name/1:ret` |
| `Unk0530` | 1 | `Infer.unk_vars/2:ret` |
| `Unk0531` | 3 | `Infer.whole_program/4:p0`, `PortAnalysis.collect_groups/1:ret`, `PortAnalysis.param_name_index/1:p0` |
| `Unk0532` | 2 | `Infer.whole_program/4:p1`, `Transpile.stdlib_map/0:ret` |
| `Unk0533` | 2 | `Infer.whole_program/4:p2`, `PortAnalysis.cluster_sums/1:ret` |
| `Unk0534` | 1 | `Infer.whole_program/4:p3` |
| `Unk0535` | 1 | `Infer.xmod_cache/0:ret` |
| `Unk0536` | 2 | `Interp.concat_chain/1:p0`, `Interp.concat_chain/1:ret` |
| `Unk0537` | 1 | `Interp.resolve_part/4:p0` |
| `Unk0538` | 2 | `Interp.resolve_part/4:ret`, `Interp.stringify/3:ret` |
| `Unk0539` | 2 | `Interp.resolve_part/4:ret`, `Interp.stringify/3:ret` |
| `Unk0540` | 1 | `JS.all_funcs/1:p0` |
| `Unk0541` | 2 | `JS.all_funcs/1:p0`, `JS.all_funcs/1:ret` |
| `Unk0542` | 1 | `JS.arm_return/3:p0` |
| `Unk0543` | 1 | `JS.arm_return/3:p1` |
| `Unk0544` | 1 | `JS.bind_lines/1:p0` |
| `Unk0545` | 4 | `JS.block_return/2:p0`, `JVM.block_value/1:p0`, `Shadow.ded_block/4:ret`, `Shadow.dedup/3:ret` |
| `Unk0546` | 1 | `JS.case_arm_js/2:p0` |
| `Unk0547` | 1 | `JS.clause_js/2:p0` |
| `Unk0548` | 4 | `JS.clause_return/3:p1`, `JS.guarded_return/4:p2`, `JVM.clause_value/2:p1`, `Shadow.dedup/3:p1` |
| `Unk0549` | 1 | `JS.cp_lit/2:p0` |
| `Unk0550` | 1 | `JS.dispatcher_js/5:p0` |
| `Unk0551` | 1 | `JS.dispatcher_js/5:p1` |
| `Unk0552` | 1 | `JS.dispatcher_js/5:p2` |
| `Unk0553` | 1 | `JS.dispatcher_js/5:p3` |
| `Unk0554` | 2 | `JS.float?/1:p0`, `JS.num_js/2:p0` |
| `Unk0555` | 1 | `JS.guarded_return/4:p1` |
| `Unk0556` | 3 | `JS.js_atom/1:p0`, `JS.js_str/1:p0`, `JS.lit_js/2:p0` |
| `Unk0557` | 1 | `JS.js_guard!/4:p1` |
| `Unk0558` | 1 | `JS.js_guard!/4:p2` |
| `Unk0559` | 1 | `JS.js_guard!/4:p3` |
| `Unk0560` | 1 | `JS.js_guard!/4:ret` |
| `Unk0561` | 1 | `JS.js_number_int?/1:p0` |
| `Unk0562` | 1 | `JS.mangle/3:p0` |
| `Unk0563` | 1 | `JS.mangle/3:p1` |
| `Unk0564` | 1 | `JS.mangle/3:p2` |
| `Unk0565` | 1 | `JS.match_elems/3:p0` |
| `Unk0566` | 1 | `JS.match_elems/3:ret` |
| `Unk0567` | 1 | `JS.paren/2:p0` |
| `Unk0568` | 1 | `JS.paren/2:p1` |
| `Unk0569` | 1 | `JS.pascal?/1:p0` |
| `Unk0570` | 1 | `JS.pat_match/3:ret` |
| `Unk0571` | 1 | `JS.reject_mixed_int_mode!/1:ret` |
| `Unk0572` | 1 | `JS.reject_wide_int!/2:p0` |
| `Unk0573` | 1 | `JS.reject_wide_int!/2:p1` |
| `Unk0574` | 1 | `JS.reject_wide_int!/2:ret` |
| `Unk0575` | 1 | `JS.stmt_js/2:p0` |
| `Unk0576` | 1 | `JS.stmt_return/2:p0` |
| `Unk0577` | 1 | `JS.stmt_return/2:p1` |
| `Unk0578` | 1 | `JS.struct_name_set/1:ret` |
| `Unk0579` | 1 | `JS.sum_ctor_map/1:ret` |
| `Unk0580` | 1 | `JS.sum_guard_js/1:p0` |
| `Unk0581` | 1 | `JVM.all_funcs/1:p0` |
| `Unk0582` | 2 | `JVM.all_funcs/1:p0`, `JVM.all_funcs/1:ret` |
| `Unk0583` | 1 | `JVM.bind_str/1:p0` |
| `Unk0584` | 1 | `JVM.case_arms/2:p0` |
| `Unk0585` | 1 | `JVM.case_arms/2:ret` |
| `Unk0586` | 1 | `JVM.case_arms/2:ret` |
| `Unk0587` | 4 | `JVM.clause_lines/1:p0`, `JVM.closed_or_cond/3:p2`, `JVM.prepend_if/3:p2`, `JVM.run_or_cond/3:p2` |
| `Unk0588` | 1 | `JVM.clause_match/1:p0` |
| `Unk0589` | 1 | `JVM.clause_match/1:ret` |
| `Unk0590` | 3 | `JVM.closed_or_cond/3:p0`, `JVM.prepend_if/3:p0`, `JVM.run_or_cond/3:p0` |
| `Unk0591` | 1 | `JVM.function_kt/1:p0` |
| `Unk0592` | 1 | `JVM.guarded_arm/2:p1` |
| `Unk0593` | 1 | `JVM.guarded_return/3:p0` |
| `Unk0594` | 1 | `JVM.guarded_return/3:p1` |
| `Unk0595` | 1 | `JVM.guarded_return/3:p2` |
| `Unk0596` | 1 | `JVM.kotlin_module/2:p1` |
| `Unk0597` | 2 | `JVM.kt_str/1:p0`, `JVM.lit_kt/1:p0` |
| `Unk0598` | 1 | `JVM.kt_type/1:ret` |
| `Unk0599` | 1 | `JVM.pat_match/2:ret` |
| `Unk0600` | 1 | `JVM.stmt_kt/1:p0` |
| `Unk0601` | 1 | `JVM.stmt_value/1:p0` |
| `Unk0602` | 1 | `JVM.sum_decl/1:p0` |
| `Unk0603` | 1 | `JVM.to_jar/3:p2` |
| `Unk0604` | 1 | `JVM.to_jar/3:ret` |
| `Unk0605` | 1 | `JVM.variant_decl/2:p0` |
| `Unk0606` | 1 | `JVM.variant_decl/2:p1` |
| `Unk0607` | 4 | `Lexer.binify/1:ret`, `Lexer.capture_hole/3:ret`, `Lexer.lex_parts/3:p2`, `Lexer.lex_parts/3:ret` |
| `Unk0608` | 1 | `Lexer.capture_hole/3:ret` |
| `Unk0609` | 1 | `Lexer.char_escape/1:p0` |
| `Unk0610` | 2 | `Lexer.char_escape/1:ret`, `Lexer.parse_hex!/1:p0` |
| `Unk0611` | 2 | `Lexer.close_char/1:ret`, `Lexer.lex_char/1:ret` |
| `Unk0612` | 1 | `Lexer.collapse_nl/1:p0` |
| `Unk0613` | 1 | `Lexer.collapse_nl/1:ret` |
| `Unk0614` | 1 | `Lexer.detokenize/2:p0` |
| `Unk0615` | 1 | `Lexer.escape_str/1:p0` |
...
| `Unk0617` | 2 | `Lexer.lex/2:p1`, `Lexer.word/1:ret` |
| `Unk0618` | 2 | `Lexer.lex/2:ret`, `Lexer.tokenize_trivia/1:ret` |
| `Unk0619` | 1 | `Lexer.lex_char/1:ret` |
| `Unk0620` | 2 | `Lexer.lex_parts/3:p2`, `Lexer.lex_parts/3:ret` |
| `Unk0621` | 1 | `Lexer.lex_parts/3:ret` |
| `Unk0622` | 3 | `Lexer.lex_string_token/1:ret`, `Lexer.string_token/1:p0`, `Lexer.string_token/1:ret` |
| `Unk0623` | 1 | `Lexer.lex_string_token/1:ret` |
| `Unk0624` | 2 | `Lexer.lex_string_token/1:ret`, `Lexer.string_token/1:ret` |
| `Unk0625` | 1 | `Lexer.punct/1:ret` |
| `Unk0626` | 1 | `Lexer.strip_trivia/1:p0` |
| `Unk0627` | 1 | `Lexer.strip_trivia/1:ret` |
| `Unk0628` | 1 | `Lexer.take_comment/1:ret` |
| `Unk0629` | 4 | `Lexer.take_hex/2:p0`, `Lexer.take_hex/2:ret`, `Lexer.take_hex/3:p0`, `Lexer.take_hex/3:ret` |
| `Unk0630` | 1 | `Lexer.tok_str/2:p0` |
| `Unk0631` | 1 | `Lexer.tokenize/1:ret` |
| `Unk0632` | 2 | `Livebook.eval/1:ret`, `Livebook.output/1:ret` |
| `Unk0633` | 2 | `Livebook.run/2:p0`, `Livebook.run/2:ret` |
| `Unk0634` | 1 | `Livebook.run/2:ret` |
| `Unk0635` | 1 | `Livebook.session_pid/0:ret` |
| `Unk0636` | 4 | `Lower.add_list_elem_vars/2:p0`, `Lower.add_list_elem_vars/2:ret`, `Lower.add_var/2:p0`, `Lower.add_var/2:ret` |
| `Unk0637` | 1 | `Lower.add_list_elem_vars/2:p1` |
| `Unk0638` | 1 | `Lower.add_var/2:p1` |
| `Unk0639` | 1 | `Lower.all_pat_vars/1:ret` |
| `Unk0640` | 1 | `Lower.arm_rebinds/3:p0` |
| `Unk0641` | 3 | `Lower.arm_rebinds/3:p1`, `Lower.iso_cons_positions/1:ret`, `Lower.rust_scrut/2:p1` |
| `Unk0642` | 4 | `Lower.arm_rebinds/3:p2`, `Lower.collect_ids/2:p1`, `Lower.collect_ids/2:ret`, `Lower.used_ids/1:ret` |
| `Unk0643` | 1 | `Lower.arm_rebinds/3:ret` |
| `Unk0644` | 1 | `Lower.assoc/1:ret` |
| `Unk0645` | 1 | `Lower.body_ast/2:p0` |
| `Unk0646` | 1 | `Lower.body_ast/2:p1` |
| `Unk0647` | 1 | `Lower.body_ast/2:ret` |
| `Unk0648` | 4 | `Lower.borrow_arg/5:p2`, `Lower.insert_borrows/4:p1`, `Lower.owned_arg?/2:p1`, `Lower.param_rtypes/2:p1` |
| `Unk0649` | 5 | `Lower.borrow_arg/5:p2`, `Lower.insert_borrows/4:p1`, `Lower.owned_arg?/2:p1`, `Lower.param_rtypes/2:p0`, `Lower.param_rtypes/2:p1` |
| `Unk0650` | 3 | `Lower.borrow_arg/5:p4`, `Lower.insert_borrows/4:p2`, `Lower.owned_field_var?/2:p1` |
| `Unk0651` | 1 | `Lower.borrow_arg/5:ret` |
| `Unk0652` | 1 | `Lower.borrowed_in_pat/2:ret` |
| `Unk0653` | 1 | `Lower.borrowed_vars/2:p0` |
| `Unk0654` | 1 | `Lower.borrowed_vars/2:p1` |
| `Unk0655` | 1 | `Lower.borrowed_vars/2:ret` |
| `Unk0656` | 1 | `Lower.build_env/3:p1` |
| `Unk0657` | 1 | `Lower.build_env/3:p2` |
| `Unk0658` | 2 | `Lower.build_env/3:ret`, `Lower.check!/2:p1` |
| `Unk0659` | 3 | `Lower.build_meta/1:ret`, `Lower.ctx/4:p0`, `Lower.to_rust/6:p2` |
| `Unk0660` | 4 | `Lower.build_struct_meta/1:ret`, `Lower.ctx/4:p1`, `Lower.to_elixir/4:p3`, `Lower.to_rust/6:p4` |
| `Unk0661` | 9 | `Lower.case_guard/3:p1`, `Lower.disp/2:p1`, `Lower.emit/3:p1`, `Lower.emit_ast/2:p1`, `Lower.emit_block/3:p1`, `Lower.emit_expr/2:p1`, `Lower.guard_kw/1:p0`, `Lower.guard_str/4:p1`, `Lower.p/4:p2` |
| `Unk0662` | 13 | `Lower.case_guard/3:p2`, `Lower.coerce_string_ast/2:p1`, `Lower.coerce_string_branch/2:p1`, `Lower.emit/3:p2`, `Lower.emit_block/3:p2`, `Lower.guard_str/4:p2`, `Lower.p/4:p3`, `Lower.result_payload/3:p2`, `Lower.rust_case/4:p3`, `Lower.rust_owned_elem/2:p1`, `Lower.slice_var?/2:p1`, `Lower.tail_slice_id?/2:p1`, `Lower.with_chain_rs/4:p3` |
| `Unk0663` | 13 | `Lower.case_guard/3:p2`, `Lower.coerce_string_ast/2:p1`, `Lower.coerce_string_branch/2:p1`, `Lower.emit/3:p2`, `Lower.emit_block/3:p2`, `Lower.guard_str/4:p2`, `Lower.p/4:p3`, `Lower.result_payload/3:p2`, `Lower.rust_case/4:p3`, `Lower.rust_owned_elem/2:p1`, `Lower.slice_var?/2:p1`, `Lower.tail_slice_id?/2:p1`, `Lower.with_chain_rs/4:p3` |
| `Unk0664` | 1 | `Lower.char_vars/2:p0` |
| `Unk0665` | 1 | `Lower.char_vars/2:p1` |
| `Unk0666` | 1 | `Lower.char_vars/2:ret` |
| `Unk0667` | 14 | `Lower.check!/2:p0`, `Lower.compile/5:p1`, `Lower.compile_beam/4:p1`, `Lower.compile_elixir/4:p1`, `Lower.elixir_clauses/3:p0`, `Lower.fn_all_tvars/3:p0`, `Lower.infer_concrete_params/3:p0`, `Lower.iso_cons_positions/1:p0`, `Lower.pair_inst/2:p0`, `Lower.parametric_used?/2:p0`, `Lower.rust_fn/4:p0`, `Lower.rust_total_shim?/1:p0`, `Lower.to_elixir/4:p0`, `Lower.to_rust/6:p0` |
| `Unk0668` | 1 | `Lower.check!/2:ret` |
| `Unk0669` | 2 | `Lower.collect_ids/2:p0`, `Lower.used_ids/1:p0` |
| `Unk0670` | 1 | `Lower.collect_owned_field_vars/3:p0` |
| `Unk0671` | 11 | `Lower.collect_owned_field_vars/3:p1`, `Lower.ctx/4:ret`, `Lower.ofb/3:p1`, `Lower.owned_field_binders/2:p1`, `Lower.owned_scrut?/2:p1`, `Lower.rust_const/2:p1`, `Lower.rust_fn/4:p1`, `Lower.rust_impl/4:p2`, `Lower.rust_impl_method/6:p3`, `Lower.trait_impl_block/4:p2`, `Lower.user_type?/2:p1` |
| `Unk0672` | 11 | `Lower.collect_owned_field_vars/3:p1`, `Lower.ctx/4:ret`, `Lower.ofb/3:p1`, `Lower.owned_field_binders/2:p1`, `Lower.owned_scrut?/2:p1`, `Lower.rust_const/2:p1`, `Lower.rust_fn/4:p1`, `Lower.rust_impl/4:p2`, `Lower.rust_impl_method/6:p3`, `Lower.trait_impl_block/4:p2`, `Lower.user_type?/2:p1` |
| `Unk0673` | 6 | `Lower.collect_owned_field_vars/3:p2`, `Lower.collect_owned_field_vars/3:ret`, `Lower.ofb/3:p2`, `Lower.ofb/3:ret`, `Lower.owned_field_binders/2:ret`, `Lower.slice_binders/2:ret` |
| `Unk0674` | 1 | `Lower.compile/5:p2` |
| `Unk0675` | 1 | `Lower.compile/5:p3` |
| `Unk0676` | 1 | `Lower.compile_beam/4:p2` |
| `Unk0677` | 1 | `Lower.compile_beam/4:p3` |
| `Unk0678` | 1 | `Lower.compile_elixir/4:p2` |
| `Unk0679` | 1 | `Lower.compile_elixir/4:p3` |
| `Unk0680` | 1 | `Lower.compile_module/1:p0` |
| `Unk0681` | 1 | `Lower.compile_module_beam/1:p0` |
| `Unk0682` | 1 | `Lower.cons_tail_names/1:ret` |
| `Unk0683` | 3 | `Lower.const_set/1:p0`, `Lower.ex_const/2:p0`, `Lower.rust_const/2:p0` |
| `Unk0684` | 2 | `Lower.const_set/1:ret`, `Lower.ctx/4:p2` |
| `Unk0685` | 3 | `Lower.core_pat_rs/2:p1`, `Lower.pat_rs/2:p1`, `Lower.resolve_rust_pats/2:p1` |
| `Unk0686` | 1 | `Lower.core_pat_vars/1:ret` |
| `Unk0687` | 1 | `Lower.ctx/4:p3` |
| `Unk0688` | 2 | `Lower.deref_ids/2:p0`, `Lower.deref_ids/2:ret` |
| `Unk0689` | 1 | `Lower.deref_ids/2:p1` |
| `Unk0690` | 2 | `Lower.elixir_clauses/3:p1`, `Lower.ex_const/2:p1` |
| `Unk0691` | 1 | `Lower.emit_ast/2:ret` |
| `Unk0692` | 1 | `Lower.emit_ctx/1:p0` |
| `Unk0693` | 5 | `Lower.emit_ctx/1:ret`, `Lower.rust_fn/4:p3`, `Lower.rust_impl/4:p3`, `Lower.rust_impl_method/6:p5`, `Lower.trait_impl_block/4:p3` |
| `Unk0694` | 5 | `Lower.emit_ctx/1:ret`, `Lower.rust_fn/4:p3`, `Lower.rust_impl/4:p3`, `Lower.rust_impl_method/6:p5`, `Lower.trait_impl_block/4:p3` |
| `Unk0695` | 1 | `Lower.emit_expr/2:ret` |
| `Unk0696` | 2 | `Lower.enum_generics/2:p0`, `Lower.enum_generics/2:p1` |
| `Unk0697` | 1 | `Lower.enum_generics/2:p1` |
| `Unk0698` | 1 | `Lower.ex_struct/1:p0` |
| `Unk0699` | 1 | `Lower.ex_typespec/1:p0` |
| `Unk0700` | 1 | `Lower.ex_use/1:p0` |
| `Unk0701` | 2 | `Lower.fn_all_tvars/3:p1`, `Lower.pair_inst/2:ret` |
| `Unk0702` | 3 | `Lower.fn_all_tvars/3:p2`, `Lower.infer_concrete_params/3:p2`, `Lower.pair_inst/2:p1` |
| `Unk0703` | 3 | `Lower.fn_all_tvars/3:p2`, `Lower.infer_concrete_params/3:p2`, `Lower.pair_inst/2:p1` |
| `Unk0704` | 1 | `Lower.guard_str/4:p0` |
| `Unk0705` | 1 | `Lower.guard_str/4:p3` |
| `Unk0706` | 1 | `Lower.impl_param/2:p0` |
| `Unk0707` | 1 | `Lower.infer_concrete_params/3:p1` |
| `Unk0708` | 1 | `Lower.infer_tvar_binding/2:p0` |
| `Unk0709` | 1 | `Lower.infer_tvar_binding/2:p1` |
| `Unk0710` | 1 | `Lower.infer_tvar_binding/2:ret` |
| `Unk0711` | 1 | `Lower.list_rpat?/1:p0` |
| `Unk0712` | 1 | `Lower.member_scan/3:p0` |
| `Unk0713` | 3 | `Lower.member_scan/3:p1`, `Lower.strip_prefix/2:p1`, `Lower.word_scan/4:p1` |
| `Unk0714` | 1 | `Lower.module_elixir/1:p0` |
| `Unk0715` | 1 | `Lower.module_rust/1:p0` |
| `Unk0716` | 2 | `Lower.ofb/3:p0`, `Lower.owned_field_binders/2:p0` |
| `Unk0717` | 1 | `Lower.owned_scrut?/2:p0` |
| `Unk0718` | 1 | `Lower.owned_str_arg/1:p0` |
| `Unk0719` | 1 | `Lower.owned_str_arg/1:ret` |
| `Unk0720` | 2 | `Lower.parametric_param_map/1:ret`, `Lower.rust_enum/3:p2` |
| `Unk0721` | 2 | `Lower.parametric_used?/2:p1`, `Lower.word_member?/2:p1` |
| `Unk0722` | 2 | `Lower.pascal?/1:p0`, `Lower.variant_info/2:p1` |
| `Unk0723` | 1 | `Lower.pipe_to_call/2:p0` |
| `Unk0724` | 1 | `Lower.proto_method_traits/1:ret` |
| `Unk0725` | 1 | `Lower.pub_sig_type_names/1:p0` |
| `Unk0726` | 1 | `Lower.pub_sig_type_names/1:ret` |
| `Unk0727` | 1 | `Lower.ref_type/2:p1` |
| `Unk0728` | 1 | `Lower.resolve_consts/2:p1` |
| `Unk0729` | 2 | `Lower.resolve_structs/2:p1`, `Lower.struct_pairs/4:p3` |
| `Unk0730` | 6 | `Lower.resolve_variants/2:p1`, `Lower.variant_info/2:p0`, `Lower.variant_info/2:ret`, `Lower.variant_lit/2:p0`, `Lower.variant_pairs/3:p0`, `Lower.variant_pairs/3:p2` |
| `Unk0731` | 3 | `Lower.resolve_variants/2:p1`, `Lower.variant_info/2:p0`, `Lower.variant_pairs/3:p2` |
| `Unk0732` | 1 | `Lower.result_parts/1:ret` |
| `Unk0733` | 2 | `Lower.rewrite_proto_calls/2:p0`, `Lower.rewrite_proto_calls/2:ret` |
| `Unk0734` | 1 | `Lower.rewrite_proto_calls/2:p1` |
| `Unk0735` | 1 | `Lower.rust_case/4:p1` |
| `Unk0736` | 1 | `Lower.rust_generics/1:p0` |
| `Unk0737` | 1 | `Lower.rust_impl_method/6:p0` |
| `Unk0738` | 1 | `Lower.rust_impl_method/6:p1` |
| `Unk0739` | 1 | `Lower.rust_lit_type/1:p0` |
| `Unk0740` | 1 | `Lower.rust_proto_body/3:p0` |
| `Unk0741` | 1 | `Lower.rust_proto_body/3:p1` |
| `Unk0742` | 1 | `Lower.rust_proto_body/3:p1` |
| `Unk0743` | 1 | `Lower.rust_proto_body/3:p2` |
| `Unk0744` | 1 | `Lower.rust_proto_body/3:ret` |
| `Unk0745` | 1 | `Lower.rust_protocols/4:ret` |
| `Unk0746` | 1 | `Lower.rust_scrut/2:p0` |
| `Unk0747` | 1 | `Lower.rust_struct/2:p0` |
| `Unk0748` | 1 | `Lower.rust_struct/2:p1` |
| `Unk0749` | 1 | `Lower.rust_trait/1:p0` |
| `Unk0750` | 1 | `Lower.rust_use/1:p0` |
| `Unk0751` | 1 | `Lower.rustify_parametric/2:p1` |
| `Unk0752` | 2 | `Lower.sig_param/2:p1`, `Lower.trait_params/2:p1` |
| `Unk0753` | 1 | `Lower.slice_binders/2:p0` |
| `Unk0754` | 1 | `Lower.slice_elem_vars/1:ret` |
| `Unk0755` | 1 | `Lower.str_lit/1:p0` |
| `Unk0756` | 2 | `Lower.strip_prefix/2:p0`, `Lower.strip_prefix/2:ret` |
| `Unk0757` | 1 | `Lower.strip_prefix/2:ret` |
| `Unk0758` | 1 | `Lower.struct_pairs/4:p0` |
| `Unk0759` | 1 | `Lower.struct_pairs/4:p1` |
| `Unk0760` | 1 | `Lower.struct_pairs/4:ret` |
| `Unk0761` | 1 | `Lower.subst_assoc/2:p1` |
| `Unk0762` | 2 | `Lower.tail_expr/1:p0`, `Lower.tail_expr/1:ret` |
| `Unk0763` | 1 | `Lower.to_elixir/4:p2` |
| `Unk0764` | 1 | `Lower.to_elixir/4:ret` |
| `Unk0765` | 1 | `Lower.to_rust/6:p3` |
| `Unk0766` | 1 | `Lower.to_rust/6:p5` |
| `Unk0767` | 1 | `Lower.to_rust/6:ret` |
| `Unk0768` | 1 | `Lower.tvar_name?/1:p0` |
| `Unk0769` | 1 | `Lower.type_idents/1:p0` |
| `Unk0770` | 1 | `Lower.type_idents/1:ret` |
| `Unk0771` | 1 | `Lower.type_param_tvars/1:p0` |
| `Unk0772` | 1 | `Lower.type_param_tvars/1:ret` |
| `Unk0773` | 1 | `Lower.user_type?/2:p0` |
| `Unk0774` | 2 | `Lower.variant_lit/2:p1`, `Lower.variant_pairs/3:ret` |
| `Unk0775` | 2 | `Lower.widen_char_arith/2:p1`, `Lower.wrap_char/2:p1` |
| `Unk0776` | 1 | `Lower.with_chain_rs/4:p0` |
| `Unk0777` | 1 | `Lower.word_member?/2:p0` |
| `Unk0778` | 1 | `Lower.word_scan/4:p0` |
| `Unk0779` | 4 | `Macro.binders_here/1:p0`, `Macro.collect_binders/1:p0`, `Macro.freshen/2:p0`, `Macro.rename/2:p0` |
| `Unk0780` | 2 | `Macro.binders_here/1:ret`, `Macro.collect_binders/1:ret` |
| `Unk0781` | 1 | `Macro.build_env/1:p0` |
| `Unk0782` | 1 | `Macro.check_portable!/2:p0` |
| `Unk0783` | 1 | `Macro.check_portable!/2:ret` |
| `Unk0784` | 1 | `Macro.expand/3:p2` |
| `Unk0785` | 1 | `Macro.freshen/2:p1` |
| `Unk0786` | 4 | `Macro.freshen/2:ret`, `Macro.rename/2:p1`, `Macro.rename/2:ret`, `Macro.substitute/2:p0` |
| `Unk0787` | 1 | `Macro.rename/2:p1` |
| `Unk0788` | 1 | `Macro.substitute/2:p1` |
| `Unk0789` | 1 | `Opaque.do_erase/2:p0` |
| `Unk0790` | 6 | `Opaque.do_erase/2:p1`, `Opaque.erase_ctx/1:ret`, `Opaque.erase_func/2:p1`, `Opaque.erase_mod/2:p1`, `Opaque.erase_struct/2:p1`, `Opaque.erase_type/2:p1` |
| `Unk0791` | 6 | `Opaque.do_erase/2:p1`, `Opaque.erase_ctx/1:ret`, `Opaque.erase_func/2:p1`, `Opaque.erase_mod/2:p1`, `Opaque.erase_struct/2:p1`, `Opaque.erase_type/2:p1` |
| `Unk0792` | 1 | `Opaque.erase_clause/3:p0` |
| `Unk0793` | 1 | `Opaque.erase_clause/3:p1` |
| `Unk0794` | 1 | `Opaque.erase_clause/3:p2` |
| `Unk0795` | 1 | `Opaque.erase_const/2:p0` |
| `Unk0796` | 1 | `Opaque.erase_const/2:p1` |
| `Unk0797` | 3 | `Opaque.erase_ctx/1:p0`, `Opaque.opaques/1:p0`, `Opaque.opaques/1:ret` |
| `Unk0798` | 1 | `Opaque.erase_func/2:p0` |
| `Unk0799` | 1 | `Opaque.erase_mod/2:p0` |
| `Unk0800` | 1 | `Opaque.erase_struct/2:p0` |
| `Unk0801` | 1 | `Opaque.erase_type/2:p0` |
| `Unk0802` | 1 | `Opaque.erase_variant/2:p0` |
| `Unk0803` | 1 | `Opaque.erase_variant/2:p1` |
| `Unk0804` | 1 | `Opaque.opaques/1:p0` |
| `Unk0805` | 4 | `Opaque.strip/3:p0`, `Opaque.strip/3:ret`, `Opaque.strip_into/3:p0`, `Opaque.strip_into/3:ret` |
| `Unk0806` | 2 | `Opaque.strip/3:p1`, `Opaque.strip_into/3:p1` |
| `Unk0807` | 4 | `Opaque.subst/2:p0`, `Opaque.subst/2:ret`, `Opaque.subst_fix/4:p0`, `Opaque.subst_fix/4:ret` |
| `Unk0808` | 2 | `Opaque.subst/2:p1`, `Opaque.subst_fix/4:p1` |
| `Unk0809` | 1 | `Opaque.subst_fix/4:p2` |
| `Unk0810` | 2 | `PatternLower.lower/2:ret`, `PatternLower.lower_list/3:ret` |
| `Unk0811` | 1 | `PatternLower.lower_clause/2:p0` |
| `Unk0812` | 1 | `PatternLower.lower_many/2:ret` |
| `Unk0813` | 2 | `PortAnalysis.analyze/1:p0`, `PortAnalysis.src_of/2:p0` |
| `Unk0814` | 1 | `PortAnalysis.analyze/1:ret` |
| `Unk0815` | 3 | `PortAnalysis.case_arm_sets/1:p0`, `PortAnalysis.clause_head_sets/1:p0`, `PortAnalysis.dispatch_sets/1:p0` |
| `Unk0816` | 2 | `PortAnalysis.case_arm_sets/1:ret`, `PortAnalysis.clause_head_sets/1:ret` |
| `Unk0817` | 2 | `PortAnalysis.cluster_sums/1:p0`, `PortAnalysis.dispatch_sets/1:ret` |
| `Unk0818` | 1 | `PortAnalysis.collect_errors/2:p0` |
| `Unk0819` | 2 | `PortAnalysis.collect_errors/2:p1`, `PortAnalysis.collect_errors/2:ret` |
| `Unk0820` | 1 | `PortAnalysis.collect_groups/1:p0` |
| `Unk0821` | 1 | `PortAnalysis.collect_structs/2:p0` |
| `Unk0822` | 2 | `PortAnalysis.collect_structs/2:p1`, `PortAnalysis.collect_structs/2:ret` |
| `Unk0823` | 1 | `PortAnalysis.error_proposal/1:p0` |
| `Unk0824` | 1 | `PortAnalysis.error_proposal/1:ret` |
| `Unk0825` | 1 | `PortAnalysis.error_shape/1:p0` |
| `Unk0826` | 1 | `PortAnalysis.error_shape/1:ret` |
| `Unk0827` | 1 | `PortAnalysis.error_shape/1:ret` |
| `Unk0828` | 6 | `PortAnalysis.errors_section/1:p0`, `PortAnalysis.holes_section/1:p0`, `PortAnalysis.sigs_section/1:p0`, `PortAnalysis.summary_section/1:p0`, `PortAnalysis.sums_section/1:p0`, `PortAnalysis.to_markdown/1:p0` |
| `Unk0829` | 1 | `PortAnalysis.head_name_pats/1:p0` |
| `Unk0830` | 1 | `PortAnalysis.head_name_pats/1:ret` |
| `Unk0831` | 1 | `PortAnalysis.head_name_pats/1:ret` |
| `Unk0832` | 2 | `PortAnalysis.module_name/1:p0`, `PortAnalysis.module_report/3:p1` |
| `Unk0833` | 1 | `PortAnalysis.module_report/3:p0` |
| `Unk0834` | 3 | `PortAnalysis.module_report/3:p2`, `PortAnalysis.src_of/2:ret`, `Transpile.inferred/1:p0` |
| `Unk0835` | 1 | `PortAnalysis.module_report/3:ret` |
| `Unk0836` | 1 | `PortAnalysis.module_stmts/1:p0` |
| `Unk0837` | 1 | `PortAnalysis.needs_review?/1:p0` |
| `Unk0838` | 1 | `PortAnalysis.param_name_index/1:ret` |
| `Unk0839` | 1 | `PortAnalysis.parse/1:p0` |
| `Unk0840` | 1 | `PortAnalysis.parse/1:ret` |
| `Unk0841` | 1 | `PortAnalysis.pascal/1:p0` |
| `Unk0842` | 1 | `PortAnalysis.pascal/1:ret` |
| `Unk0843` | 1 | `PortAnalysis.pattern_structs/1:p0` |
| `Unk0844` | 1 | `PortAnalysis.pattern_structs/1:ret` |
| `Unk0845` | 1 | `PortAnalysis.reach_note/1:ret` |
| `Unk0846` | 1 | `PortAnalysis.short/1:p0` |
| `Unk0847` | 1 | `PortAnalysis.src_of/2:p1` |
| `Unk0848` | 1 | `PortAnalysis.to_markdown/1:ret` |
| `Unk0849` | 3 | `Pratt.after_paren/2:p0`, `Pratt.after_paren/2:ret`, `Pratt.lambda_ahead?/1:p0` |
| `Unk0850` | 6 | `Pratt.assoc/1:p0`, `Pratt.bp/1:p0`, `Pratt.level/1:p0`, `Pratt.opinfo/1:p0`, `Pratt.peek_infix/1:ret`, `Pratt.same_level_root?/2:p1` |
| `Unk0851` | 1 | `Pratt.assoc/1:ret` |
| `Unk0852` | 4 | `Pratt.climb/3:p0`, `Pratt.climb/3:ret`, `Pratt.parse_expr/2:ret`, `Pratt.same_level_root?/2:p0` |
| `Unk0853` | 3 | `Pratt.collect_dots/2:p0`, `Pratt.collect_dots/2:ret`, `Pratt.parse_path/1:ret` |
| `Unk0854` | 3 | `Pratt.collect_dots/2:p0`, `Pratt.collect_dots/2:ret`, `Pratt.parse_path/1:ret` |
| `Unk0855` | 5 | `Pratt.desugar_prop/2:p0`, `Pratt.desugar_prop/2:ret`, `Pratt.desugar_propagation/1:p0`, `Pratt.desugar_propagation/1:ret`, `Pratt.parse_block/1:ret` |
| `Unk0856` | 5 | `Pratt.desugar_prop/2:p0`, `Pratt.desugar_prop/2:ret`, `Pratt.desugar_propagation/1:p0`, `Pratt.desugar_propagation/1:ret`, `Pratt.parse_block/1:ret` |
| `Unk0857` | 3 | `Pratt.desugar_prop/2:ret`, `Pratt.desugar_propagation/1:ret`, `Pratt.parse_block/1:ret` |
| `Unk0858` | 3 | `Pratt.finish_arg/2:p0`, `Pratt.finish_arg/2:ret`, `Pratt.parse_args/1:ret` |
| `Unk0859` | 2 | `Pratt.here/1:p0`, `Pratt.tok_desc/1:p0` |
| `Unk0860` | 1 | `Pratt.int_of/1:p0` |
| `Unk0861` | 22 | `Pratt.int_of/1:ret`, `Pratt.parse_capture/1:ret`, `Pratt.parse_case/1:ret`, `Pratt.parse_if/1:ret`, `Pratt.parse_lambda/1:ret`, `Pratt.parse_list/2:ret`, `Pratt.parse_map/2:p1`, `Pratt.parse_map/2:ret`, `Pratt.parse_pat/1:ret`, `Pratt.parse_pat_list/2:ret`, `Pratt.parse_pat_map/2:p1`, `Pratt.parse_pat_map/2:ret`, `Pratt.parse_pat_tuple/2:p1`, `Pratt.parse_pat_tuple/2:ret`, `Pratt.parse_postfix/2:p0`, `Pratt.parse_postfix/2:ret`, `Pratt.parse_prefix/1:ret`, `Pratt.parse_primary/1:ret`, `Pratt.parse_tuple/2:p1`, `Pratt.parse_tuple/2:ret`, `Pratt.parse_with/1:ret`, `Pratt.str_interp/1:ret` |
| `Unk0862` | 22 | `Pratt.int_of/1:ret`, `Pratt.parse_capture/1:ret`, `Pratt.parse_case/1:ret`, `Pratt.parse_if/1:ret`, `Pratt.parse_lambda/1:ret`, `Pratt.parse_list/2:ret`, `Pratt.parse_map/2:p1`, `Pratt.parse_map/2:ret`, `Pratt.parse_pat/1:ret`, `Pratt.parse_pat_list/2:ret`, `Pratt.parse_pat_map/2:p1`, `Pratt.parse_pat_map/2:ret`, `Pratt.parse_pat_tuple/2:p1`, `Pratt.parse_pat_tuple/2:ret`, `Pratt.parse_postfix/2:p0`, `Pratt.parse_postfix/2:ret`, `Pratt.parse_prefix/1:ret`, `Pratt.parse_primary/1:ret`, `Pratt.parse_tuple/2:p1`, `Pratt.parse_tuple/2:ret`, `Pratt.parse_with/1:ret`, `Pratt.str_interp/1:ret` |
| `Unk0863` | 1 | `Pratt.level/1:ret` |
| `Unk0864` | 1 | `Pratt.opinfo/1:ret` |
| `Unk0865` | 2 | `Pratt.parse_arms/2:p1`, `Pratt.parse_arms/2:ret` |
| `Unk0866` | 13 | `Pratt.parse_capture/1:ret`, `Pratt.parse_case/1:ret`, `Pratt.parse_if/1:ret`, `Pratt.parse_lambda/1:ret`, `Pratt.parse_list/2:ret`, `Pratt.parse_map/2:ret`, `Pratt.parse_postfix/2:p0`, `Pratt.parse_postfix/2:ret`, `Pratt.parse_prefix/1:ret`, `Pratt.parse_primary/1:ret`, `Pratt.parse_tuple/2:ret`, `Pratt.parse_with/1:ret`, `Pratt.str_interp/1:ret` |
| `Unk0867` | 1 | `Pratt.parse_list/2:p1` |
| `Unk0868` | 1 | `Pratt.parse_param/1:ret` |
| `Unk0869` | 1 | `Pratt.parse_param/1:ret` |
| `Unk0870` | 1 | `Pratt.parse_params/1:ret` |
| `Unk0871` | 4 | `Pratt.parse_pat/1:ret`, `Pratt.parse_pat_list/2:ret`, `Pratt.parse_pat_map/2:ret`, `Pratt.parse_pat_tuple/2:ret` |
| `Unk0872` | 2 | `Pratt.parse_pat_args/2:p1`, `Pratt.parse_pat_args/2:ret` |
| `Unk0873` | 2 | `Pratt.parse_pat_fields/2:p1`, `Pratt.parse_pat_fields/2:ret` |
| `Unk0874` | 2 | `Pratt.parse_pat_fields/2:p1`, `Pratt.parse_pat_fields/2:ret` |
| `Unk0875` | 1 | `Pratt.parse_pat_list/2:p1` |
| `Unk0876` | 3 | `Pratt.parse_pats/1:ret`, `Pratt.parse_pats/2:p1`, `Pratt.parse_pats/2:ret` |
| `Unk0877` | 1 | `Pratt.parse_stmt/1:ret` |
| `Unk0878` | 1 | `Pratt.parse_stmt/1:ret` |
| `Unk0879` | 2 | `Pratt.parse_stmts/2:p1`, `Pratt.parse_stmts/2:ret` |
| `Unk0880` | 2 | `Pratt.parse_type_args/2:p1`, `Pratt.parse_type_args/2:ret` |
| `Unk0881` | 2 | `Pratt.parse_with_clauses/2:p1`, `Pratt.parse_with_clauses/2:ret` |
| `Unk0882` | 2 | `Pratt.parse_with_clauses/2:p1`, `Pratt.parse_with_clauses/2:ret` |
| `Unk0883` | 1 | `Pratt.pascal?/1:p0` |
| `Unk0884` | 1 | `Pratt.sexpr_pat/1:p0` |
| `Unk0885` | 1 | `Pratt.sexpr_stmt/1:p0` |
| `Unk0886` | 1 | `Pratt.str_interp/1:p0` |
| `Unk0887` | 1 | `Protocol.check_assoc!/2:ret` |
| `Unk0888` | 1 | `Protocol.check_impl/3:p0` |
| `Unk0889` | 3 | `Protocol.check_impl/3:p1`, `Protocol.expand/5:p0`, `Protocol.impl_methods/2:p1` |
| `Unk0890` | 5 | `Protocol.check_impl/3:p2`, `Protocol.check_no_overlap/3:p1`, `Protocol.dispatcher/4:p3`, `Protocol.guard_for!/3:p2`, `Protocol.registry/2:ret` |
| `Unk0891` | 1 | `Protocol.check_impl/3:ret` |
| `Unk0892` | 4 | `Protocol.check_no_overlap/3:p0`, `Protocol.dispatcher/4:p2`, `Protocol.expand/5:p1`, `Protocol.impl_methods/2:p0` |
| `Unk0893` | 2 | `Protocol.check_no_overlap/3:p2`, `Protocol.runtime_dispatch_target?/1:p0` |
| `Unk0894` | 1 | `Protocol.check_no_overlap/3:ret` |
| `Unk0895` | 2 | `Protocol.dispatcher/4:p0`, `Protocol.guard_for!/3:p1` |
| `Unk0896` | 1 | `Protocol.dispatcher/4:p1` |
| `Unk0897` | 1 | `Protocol.dispatcher/4:ret` |
| `Unk0898` | 1 | `Protocol.dispatcher_params/2:p0` |
| `Unk0899` | 1 | `Protocol.dispatcher_params/2:ret` |
| `Unk0900` | 1 | `Protocol.guard_for!/3:ret` |
| `Unk0901` | 1 | `Protocol.mangle/3:p0` |
| `Unk0902` | 1 | `Protocol.mangle/3:p1` |
| `Unk0903` | 1 | `Protocol.mangle/3:p2` |
| `Unk0904` | 1 | `Protocol.param_type/1:p0` |
| `Unk0905` | 1 | `Protocol.param_type/1:ret` |
| `Unk0906` | 1 | `Protocol.registry/2:p0` |
| `Unk0907` | 1 | `Protocol.registry/2:p1` |
| `Unk0908` | 1 | `Protocol.subst_self/2:p0` |
| `Unk0909` | 1 | `Protocol.subst_self/2:p1` |
| `Unk0910` | 1 | `Protocol.subst_self/2:ret` |
| `Unk0911` | 1 | `Protocol.sum_guard/1:p0` |
| `Unk0912` | 1 | `Protocol.tag_disjunction/2:p0` |
| `Unk0913` | 1 | `Protocol.tag_disjunction/2:p1` |
| `Unk0914` | 1 | `Range.check/3:p0` |
| `Unk0915` | 1 | `Range.check/3:p1` |
| `Unk0916` | 1 | `Range.lit/1:p0` |
| `Unk0917` | 8 | `Reach.all_emittable?/2:p0`, `Reach.builder_tail_ok?/2:p0`, `Reach.ctor_aligned?/2:p1`, `Reach.parametric_constructions/2:p0`, `Reach.parametric_rs_ok?/2:p0`, `Reach.scan_func/3:p0`, `Reach.sig_uses_fn_type?/1:p0`, `Reach.uses_parametric?/2:p0` |
| `Unk0918` | 8 | `Reach.all_emittable?/2:p0`, `Reach.builder_tail_ok?/2:p0`, `Reach.ctor_aligned?/2:p1`, `Reach.parametric_constructions/2:p0`, `Reach.parametric_rs_ok?/2:p0`, `Reach.scan_func/3:p0`, `Reach.sig_uses_fn_type?/1:p0`, `Reach.uses_parametric?/2:p0` |
| `Unk0919` | 4 | `Reach.all_emittable?/2:p1`, `Reach.parametric_ctx/2:ret`, `Reach.parametric_rs_ok?/2:p1`, `Reach.scan_func/3:p2` |
| `Unk0920` | 1 | `Reach.analyze/1:ret` |
| `Unk0921` | 15 | `Reach.atom_prim_blocker/0:ret`, `Reach.bare_atom_blocker/0:ret`, `Reach.classify/3:p2`, `Reach.classify/3:ret`, `Reach.ffi/2:ret`, `Reach.fn_type_blocker/0:ret`, `Reach.int_blocker/0:ret`, `Reach.parametric_blocker/0:ret`, `Reach.ref_blocker/0:ret`, `Reach.result_value_blocker/0:ret`, `Reach.scan/3:p2`, `Reach.scan/3:ret`, `Reach.scan_func/3:ret`, `Reach.wide_prim_blocker/0:ret`, `Reach.width_blocker/0:ret` |
| `Unk0922` | 5 | `Reach.build_default/0:ret`, `Reach.check_contracts/2:p1`, `Reach.gate!/2:p1`, `Reach.validate_default/1:p0`, `Reach.validate_default/1:ret` |
| `Unk0923` | 2 | `Reach.builder_tail_ok?/2:p1`, `Reach.tail_calls_generic?/2:p1` |
| `Unk0924` | 1 | `Reach.check_contracts/2:ret` |
| `Unk0925` | 3 | `Reach.classify/3:p1`, `Reach.scan/3:p1`, `Reach.scan_func/3:p1` |
| `Unk0926` | 5 | `Reach.classify/3:p2`, `Reach.classify/3:ret`, `Reach.scan/3:p2`, `Reach.scan/3:ret`, `Reach.scan_func/3:ret` |
| `Unk0927` | 2 | `Reach.collect_ctors/2:p1`, `Reach.parametric_constructions/2:p1` |
| `Unk0928` | 2 | `Reach.collect_ctors/2:p1`, `Reach.parametric_constructions/2:p1` |
| `Unk0929` | 3 | `Reach.collect_ctors/2:ret`, `Reach.ctor_aligned?/2:p0`, `Reach.parametric_constructions/2:ret` |
| `Unk0930` | 3 | `Reach.collect_ctors/2:ret`, `Reach.ctor_aligned?/2:p0`, `Reach.parametric_constructions/2:ret` |
| `Unk0931` | 1 | `Reach.conc_erl?/2:p1` |
| `Unk0932` | 1 | `Reach.contract_message/1:p0` |
| `Unk0933` | 1 | `Reach.core/2:p0` |
| `Unk0934` | 1 | `Reach.core/2:p1` |
| `Unk0935` | 1 | `Reach.core/2:p1` |
| `Unk0936` | 2 | `Reach.deep/1:p0`, `Reach.find_atom_ordering/1:p0` |
| `Unk0937` | 3 | `Reach.deep/1:ret`, `Reach.find_atom_ordering/1:ret`, `Reach.func_symbol_violations/1:ret` |
| `Unk0938` | 1 | `Reach.emittable_parametric?/1:p0` |
| `Unk0939` | 1 | `Reach.emittable_parametric?/1:ret` |
| `Unk0940` | 1 | `Reach.fixpoint/2:p0` |
| `Unk0941` | 2 | `Reach.fixpoint/2:p1`, `Reach.fixpoint/2:ret` |
| `Unk0942` | 2 | `Reach.fixpoint/2:p1`, `Reach.fixpoint/2:ret` |
| `Unk0943` | 1 | `Reach.func_symbol_violations/1:p0` |
| `Unk0944` | 1 | `Reach.js_wide_int?/1:p0` |
| `Unk0945` | 1 | `Reach.mix_default/0:ret` |
| `Unk0946` | 1 | `Reach.parametric_type?/1:p0` |
| `Unk0947` | 1 | `Reach.pascal?/1:p0` |
| `Unk0948` | 1 | `Reach.sig_idents/1:p0` |
| `Unk0949` | 1 | `Reach.sig_idents/1:p0` |
| `Unk0950` | 1 | `Reach.sig_idents/1:ret` |
| `Unk0951` | 1 | `Reach.tail_calls_generic?/2:p0` |
| `Unk0952` | 1 | `Reach.tvar?/1:p0` |
| `Unk0953` | 1 | `Reach.tvar?/1:ret` |
| `Unk0954` | 2 | `Reach.type_has_tvar?/1:p0`, `Reach.type_idents/1:p0` |
| `Unk0955` | 1 | `Reach.type_idents/1:ret` |
| `Unk0956` | 1 | `Reach.uses_parametric?/2:p1` |
| `Unk0957` | 1 | `Repl.accumulate_line/2:p1` |
| `Unk0958` | 1 | `Repl.bind_env/2:p0` |
| `Unk0959` | 9 | `Repl.bind_env/2:ret`, `Repl.bind_with_type/4:p3`, `Repl.infer_or_unknown/3:p1`, `Repl.infer_or_unknown/3:ret`, `Repl.safe_infer/3:p1`, `Repl.safe_infer/3:ret`, `Repl.safe_infer_input/3:p1`, `Repl.safe_infer_input/3:ret`, `Repl.type_of/2:ret` |
| `Unk0960` | 4 | `Repl.bind_with_type/4:ret`, `Repl.eval_bind/4:ret`, `Repl.eval_expr/2:ret`, `Repl.eval_stmt/2:ret` |
| `Unk0961` | 1 | `Repl.candidate_pool/2:p0` |
| `Unk0962` | 1 | `Repl.candidate_pool/2:ret` |
| `Unk0963` | 2 | `Repl.common_prefix/2:p0`, `Repl.common_prefix/3:p0` |
| `Unk0964` | 2 | `Repl.common_prefix/2:p1`, `Repl.common_prefix/3:p1` |
| `Unk0965` | 1 | `Repl.complete/2:p1` |
| `Unk0966` | 2 | `Repl.complete/2:ret`, `Repl.continuation/2:p1` |
| `Unk0967` | 8 | `Repl.decl_names/1:ret`, `Repl.eval_decl/2:p0`, `Repl.eval_decl/2:ret`, `Repl.program/3:p0`, `Repl.reload/2:p0`, `Repl.run/4:p2`, `Repl.safe_decl/1:p0`, `Repl.units_src/1:p0` |
| `Unk0968` | 1 | `Repl.describe/1:p0` |
| `Unk0969` | 1 | `Repl.describe/1:ret` |
| `Unk0970` | 1 | `Repl.eval/2:p0` |
| `Unk0971` | 1 | `Repl.eval/2:ret` |
| `Unk0972` | 2 | `Repl.eval_decl/2:p0`, `Repl.reload/2:p0` |
| `Unk0973` | 6 | `Repl.eval_decl/2:p0`, `Repl.program/3:p0`, `Repl.reload/2:p0`, `Repl.run/4:p2`, `Repl.safe_decl/1:p0`, `Repl.units_src/1:p0` |
...
| `Unk0987` | 1 | `Repl.type_of/2:p0` |
| `Unk0988` | 1 | `SelfHost.badge/1:p0` |
| `Unk0989` | 1 | `SelfHost.composition/0:ret` |
| `Unk0990` | 1 | `SelfHost.count/1:p0` |
| `Unk0991` | 1 | `SelfHost.evidence/1:p0` |
| `Unk0992` | 1 | `SelfHost.external_host_calls/1:p0` |
| `Unk0993` | 1 | `SelfHost.external_host_calls/1:p0` |
| `Unk0994` | 1 | `SelfHost.external_host_calls/1:p0` |
| `Unk0995` | 1 | `SelfHost.external_host_calls/1:ret` |
| `Unk0996` | 1 | `SelfHost.ffi_ledger/0:ret` |
| `Unk0997` | 1 | `SelfHost.passes/0:ret` |
| `Unk0998` | 1 | `SelfHost.sibling_compose_call?/2:p0` |
| `Unk0999` | 1 | `SelfHost.sibling_compose_call?/2:p1` |
| `Unk1000` | 1 | `SelfHost.stages/0:ret` |
| `Unk1001` | 1 | `SelfHost.status_markdown/1:p0` |
| `Unk1002` | 1 | `Shadow.ded_bind/5:p0` |
| `Unk1003` | 3 | `Shadow.ded_bind/5:p2`, `Shadow.ded_expr/3:p0`, `Shadow.ded_expr/3:ret` |
| `Unk1004` | 1 | `Shadow.ded_bind/5:p3` |
| `Unk1005` | 4 | `Shadow.ded_bind/5:p4`, `Shadow.ded_block/4:p3`, `Shadow.ded_expr/3:p2`, `Shadow.dedup/3:p2` |
| `Unk1006` | 4 | `Shadow.ded_bind/5:p4`, `Shadow.ded_block/4:p3`, `Shadow.ded_expr/3:p2`, `Shadow.dedup/3:p2` |
| `Unk1007` | 4 | `Shadow.ded_bind/5:p4`, `Shadow.ded_block/4:p3`, `Shadow.ded_expr/3:p2`, `Shadow.dedup/3:p2` |
| `Unk1008` | 1 | `Shadow.ded_bind/5:ret` |
| `Unk1009` | 2 | `Shadow.ded_block/4:p0`, `Shadow.dedup/3:p0` |
| `Unk1010` | 2 | `Shadow.ded_block/4:p1`, `Shadow.ded_expr/3:p1` |
| `Unk1011` | 2 | `Shadow.ded_block/4:p1`, `Shadow.ded_expr/3:p1` |
| `Unk1012` | 1 | `Shadow.ded_block/4:p2` |
| `Unk1013` | 1 | `Shadow.pat_var_names/1:ret` |
| `Unk1014` | 1 | `Test.run/2:p1` |
| `Unk1015` | 1 | `Test.run/2:ret` |
| `Unk1016` | 1 | `Tour.build_cell/1:p0` |
| `Unk1017` | 1 | `Tour.build_cell/1:ret` |
| `Unk1018` | 1 | `Tour.build_reach_example/1:p0` |
| `Unk1019` | 1 | `Tour.build_reach_example/1:ret` |
| `Unk1020` | 1 | `Tour.elixir_module/1:ret` |
| `Unk1021` | 2 | `Tour.encode/2:p0`, `Tour.encode_string/1:p0` |
| `Unk1022` | 1 | `Tour.generate/0:ret` |
| `Unk1023` | 1 | `Tour.reach_map/1:ret` |
| `Unk1024` | 1 | `Transpile.add_clause/2:p0` |
| `Unk1025` | 5 | `Transpile.add_clause/2:p0`, `Transpile.add_clause/2:p1`, `Transpile.build_clause/2:ret`, `Transpile.new_group/3:p1`, `Transpile.same_group?/3:p2` |
| `Unk1026` | 2 | `Transpile.add_clause/2:ret`, `Transpile.new_group/3:ret` |
| `Unk1027` | 1 | `Transpile.build_clause/2:p0` |
| `Unk1028` | 1 | `Transpile.build_clause/2:p1` |
| `Unk1029` | 1 | `Transpile.case_arm/1:p0` |
| `Unk1030` | 1 | `Transpile.classify/1:ret` |
| `Unk1031` | 4 | `Transpile.close_group/2:p0`, `Transpile.close_group/2:p1`, `Transpile.close_group/2:ret`, `Transpile.def_groups/1:ret` |
| `Unk1032` | 1 | `Transpile.escape/1:p0` |
| `Unk1033` | 1 | `Transpile.escape/1:ret` |
| `Unk1034` | 2 | `Transpile.escape_lit/1:p0`, `Transpile.string_part/1:p0` |
| `Unk1035` | 1 | `Transpile.flush/2:p0` |
| `Unk1036` | 2 | `Transpile.flush/2:p1`, `Transpile.render_items/3:p1` |
| `Unk1037` | 2 | `Transpile.flush/2:p1`, `Transpile.render_items/3:p1` |
| `Unk1038` | 1 | `Transpile.hole_sig?/1:p0` |
| `Unk1039` | 2 | `Transpile.infer_program/1:p0`, `Transpile.infer_sigs/1:p0` |
| `Unk1040` | 3 | `Transpile.infer_program/1:ret`, `Transpile.infer_sigs/1:ret`, `Transpile.inferred/1:ret` |
| `Unk1041` | 1 | `Transpile.infer_report/1:p0` |
| `Unk1042` | 1 | `Transpile.infer_report/1:ret` |
| `Unk1043` | 1 | `Transpile.max_placeholder/1:p0` |
| `Unk1044` | 4 | `Transpile.mod_str/1:p0`, `Transpile.short_name/1:p0`, `Transpile.snippet/1:p0`, `Transpile.var_name/1:p0` |
| `Unk1045` | 1 | `Transpile.module_groups/1:p0` |
| `Unk1046` | 1 | `Transpile.module_groups/1:ret` |
| `Unk1047` | 1 | `Transpile.moduledoc_lines/1:p0` |
| `Unk1048` | 1 | `Transpile.name_str/1:p0` |
| `Unk1049` | 1 | `Transpile.name_str/1:ret` |
| `Unk1050` | 1 | `Transpile.new_group/3:p0` |
| `Unk1051` | 1 | `Transpile.new_group/3:p2` |
| `Unk1052` | 1 | `Transpile.one_line/1:p0` |
| `Unk1053` | 1 | `Transpile.one_line/1:ret` |
| `Unk1054` | 1 | `Transpile.prime_xmod/1:p0` |
| `Unk1055` | 1 | `Transpile.prime_xmod/1:ret` |
| `Unk1056` | 1 | `Transpile.rank/1:p0` |
| `Unk1057` | 1 | `Transpile.rank/1:ret` |
| `Unk1058` | 1 | `Transpile.render_body/1:ret` |
| `Unk1059` | 1 | `Transpile.render_clause/2:p1` |
| `Unk1060` | 2 | `Transpile.render_items/3:p2`, `Transpile.struct_decl/2:p0` |
| `Unk1061` | 1 | `Transpile.same_group?/3:p0` |
| `Unk1062` | 1 | `Transpile.same_group?/3:p1` |
| `Unk1063` | 1 | `Transpile.sibling_module?/2:p0` |
| `Unk1064` | 1 | `Transpile.simple?/1:p0` |
| `Unk1065` | 1 | `Transpile.string_part/1:ret` |
| `Unk1066` | 1 | `Transpile.string_parts/1:p0` |
| `Unk1067` | 1 | `Transpile.string_parts/1:ret` |
| `Unk1068` | 1 | `Transpile.struct_decl/2:p1` |
| `Unk1069` | 1 | `Transpile.struct_field?/1:p0` |
