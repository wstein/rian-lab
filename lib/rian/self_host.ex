  ...
  **measured boundary** and a **counted** FFI-crutch ledger, so the marching front
  ...
  @stages [
    ...
    %{
      ...
      note:
        "type inference agrees with the REAL Rian.Check.infer over 9 Core nodes — literals incl. float/char, ids in a typing env, unary/binary with operand-directed arithmetic, prim calls, and `if`-branch LUB; cross-width join widening/case/lists/lambdas remain (selfhost_check.rian is a separate TOY-language spike)"
    },
    %{
      id: :exhaustiveness,
